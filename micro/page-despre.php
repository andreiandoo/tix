...
<div class="overflow-x-hidden font-body bg-dark-900 text-zinc-200" x-data="{ mobileMenu: false }">
  ...
  <!-- Cursor glow effect -->
  <div class="hidden cursor-glow lg:block" id="cursor-glow"></div>
  ...
  <section class="relative flex items-center min-h-screen pt-20 overflow-hidden hero-gradient">
    ...
    <div class="relative z-10 max-w-5xl px-6 py-20 mx-auto text-center lg:px-8">
      <!-- Eyebrow -->
      <div class="reveal inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm">
        ...
        <span class="text-sm font-medium text-white/70">Povestea Noastră</span>
      </div>
      ...
      <!-- Subheading -->
      <p class="max-w-3xl mx-auto mb-12 text-xl leading-relaxed md:text-2xl text-white/60 reveal reveal-delay-2">
        Am început cu o observație simplă: organizatorii de evenimente
        <span class="font-medium text-white">merită instrumente mai bune</span>.
        Și am construit platforma pe care ne-am fi dorit să existe.
      </p>

      <!-- Scroll indicator -->
      <div class="reveal reveal-delay-3">
        <a href="#story" class="inline-flex flex-col items-center gap-2 transition-colors text-white/40 hover:text-white/70">
  ...
  <!-- ==================== ORIGIN STORY ==================== -->
  <section class="relative py-32 overflow-hidden" id="story">
    <div class="max-w-6xl px-6 mx-auto lg:px-8">
      <div class="grid items-center gap-16 lg:grid-cols-2">
        <!-- Content -->
        <div class="reveal">
          <span class="text-sm font-medium tracking-widest uppercase text-brand-rose">Originea</span>
          <h2 class="mt-4 mb-6 text-4xl font-bold leading-tight text-white font-display md:text-5xl">
            Născuți din<br><span class="text-gradient-warm">frustrare</span>
          </h2>
          <div class="space-y-6 text-lg leading-relaxed text-white/60">
            <p>
        ...
        <div class="reveal reveal-delay-1">
          <div class="relative">
            <div class="p-8 gradient-border rounded-3xl md:p-10 bg-dark-800/50 backdrop-blur-sm" style="--dark-800: #13131c;">
              <span class="quote-mark">"</span>
              <blockquote class="relative z-10 text-2xl font-light leading-relaxed text-white md:text-3xl">
                O soluție de ticketing proiectată de oameni care
                <span class="font-medium text-gradient">înțeleg evenimentele</span>,
                pentru oameni care le creează.
              </blockquote>
            </div>

            <!-- Floating badge -->
            <div class="absolute px-6 py-4 border shadow-xl -bottom-6 -right-6 bg-dark-800 rounded-2xl border-brand-violet/30 animate-float">
              <div class="flex items-center gap-3">
                <span class="text-3xl">🎯</span>
                <div>
                  <div class="font-semibold text-brand-violet">2020</div>
                  <div class="text-sm text-white/50">Anul începutului</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="max-w-6xl px-6 mx-auto lg:px-8">
      <div class="grid grid-cols-2 gap-6 lg:grid-cols-4">
        ...
        <div class="stat-card reveal" style="--stat-color: #7c3aed;" x-data="{ count: 0 }" x-intersect="$el.classList.contains('counted') || (count = 0, $el.classList.add('counted'), setInterval(() => count < 5000 && (count += 100), 20))">
          <div class="mb-2 text-4xl font-bold md:text-5xl font-display text-gradient" x-text="count.toLocaleString() + '+'">5,000+</div>
        ...
        <div class="stat-card reveal reveal-delay-1" style="--stat-color: #06b6d4;" x-data="{ count: 0 }" x-intersect="$el.classList.contains('counted') || (count = 0, $el.classList.add('counted'), setInterval(() => count < 2 && (count += 0.1), 50))">
          <div class="mb-2 text-4xl font-bold md:text-5xl font-display text-gradient"><span x-text="count.toFixed(1)">2.0</span>M+</div>
        ...
        <div class="stat-card reveal reveal-delay-2" style="--stat-color: #10b981;" x-data="{ count: 0 }" x-intersect="$el.classList.contains('counted') || (count = 0, $el.classList.add('counted'), setInterval(() => count < 15 && (count += 1), 100))">
          <div class="mb-2 text-4xl font-bold md:text-5xl font-display text-gradient-trust" x-text="count">15</div>
        ...
        <div class="stat-card reveal reveal-delay-3" style="--stat-color: #f59e0b;" x-data="{ count: 0 }" x-intersect="$el.classList.contains('counted') || (count = 0, $el.classList.add('counted'), setInterval(() => count < 99 && (count += 2), 30))">
          <div class="mb-2 text-4xl font-bold md:text-5xl font-display text-gradient-warm"><span x-text="count">99</span>%</div>
  ...
  <section class="relative py-32 overflow-hidden bg-dark-850">
    ...
    <div class="relative max-w-6xl px-6 mx-auto lg:px-8">
      <!-- Section Header -->
      <div class="max-w-3xl mx-auto mb-20 text-center reveal">
        <span class="text-sm font-medium tracking-widest uppercase text-brand-cyan">Filozofia Noastră</span>
        <h2 class="mt-4 mb-6 text-4xl font-bold text-white font-display md:text-6xl">În ce <span class="text-gradient">credem</span></h2>
      ...
      <div class="grid gap-6 md:grid-cols-2">
        ...
        <div class="belief-card reveal">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="mb-2 text-xl font-semibold text-white">Evenimentele Merită Tehnologie Mai Bună</h3>
        ...
        <div class="belief-card reveal reveal-delay-1">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="mb-2 text-xl font-semibold text-white">Clienții Tăi Sunt CLIENȚII TĂI</h3>
        ...
        <div class="belief-card reveal reveal-delay-2">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="mb-2 text-xl font-semibold text-white">Prețuri Corecte și Transparente</h3>
        ...
        <div class="belief-card reveal reveal-delay-3">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="mb-2 text-xl font-semibold text-white">Flexibilitatea Bate Rigiditatea</h3>
        ...
        <div class="belief-card md:col-span-2 reveal reveal-delay-4">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="mb-2 text-xl font-semibold text-white">Tehnologia Ar Trebui Să Împuternicească, Nu Să Complice</h3>
  ...
  <section class="relative py-32 overflow-hidden">
    <div class="max-w-6xl px-6 mx-auto lg:px-8">
      <!-- Section Header -->
      <div class="max-w-3xl mx-auto mb-20 text-center reveal">
        <span class="text-sm font-medium tracking-widest uppercase text-brand-green">Valorile Noastre</span>
        <h2 class="mt-4 mb-6 text-4xl font-bold text-white font-display md:text-6xl">Ce ne <span class="text-gradient-trust">definește</span></h2>
      </div>
      ...
      <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="value-card reveal" style="--card-glow: rgba(124, 58, 237, 0.15); --card-border: rgba(124, 58, 237, 0.3); --card-shadow: rgba(124, 58, 237, 0.3);">
          <div class="flex items-center justify-center w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br from-brand-violet to-brand-violet/50">
            <svg class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
          </div>
          <h3 class="mb-3 text-2xl font-semibold text-white">Transparență</h3>
          <p class="leading-relaxed text-white/50">Fără taxe ascunse. Fără termeni îngropați. Fără surprize. Comunicăm clar și onest, chiar și când mesajul e dificil.</p>
        </div>
        ...
        <div class="value-card reveal reveal-delay-1" style="--card-glow: rgba(6, 182, 212, 0.15); --card-border: rgba(6, 182, 212, 0.3); --card-shadow: rgba(6, 182, 212, 0.3);">
          <div class="flex items-center justify-center w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br from-brand-cyan to-brand-cyan/50">
            <svg class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
          </div>
          <h3 class="mb-3 text-2xl font-semibold text-white">Fiabilitate</h3>
          <p class="leading-relaxed text-white/50">Evenimentele nu pot eșua. Când ușile se deschid, totul trebuie să funcționeze. Construim sisteme redundante și testăm obsesiv.</p>
        </div>
        ...
        <div class="value-card reveal reveal-delay-2" style="--card-glow: rgba(245, 158, 11, 0.15); --card-border: rgba(245, 158, 11, 0.3); --card-shadow: rgba(245, 158, 11, 0.3);">
          <div class="flex items-center justify-center w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br from-brand-amber to-brand-amber/50">
          ...
          <h3 class="mb-3 text-2xl font-semibold text-white">Inovație</h3>
          <p class="leading-relaxed text-white/50">Industria evenimentelor evoluează constant. Stăm în față ascultând organizatorii și îmbunătățind continuu platforma.</p>
        </div>
        ...
        <div class="value-card reveal reveal-delay-3" style="--card-glow: rgba(16, 185, 129, 0.15); --card-border: rgba(16, 185, 129, 0.3); --card-shadow: rgba(16, 185, 129, 0.3);">
          <div class="flex items-center justify-center w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br from-brand-green to-brand-green/50">
            <svg class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
          </div>
          <h3 class="mb-3 text-2xl font-semibold text-white">Suport</h3>
          <p class="leading-relaxed text-white/50">Întrebările primesc răspunsuri. Problemele sunt rezolvate. Oameni reali răspund la probleme reale. Suntem în asta împreună.</p>
        </div>
        ...
        <div class="value-card md:col-span-2 lg:col-span-2 reveal reveal-delay-4" style="--card-glow: rgba(244, 63, 94, 0.15); --card-border: rgba(244, 63, 94, 0.3); --card-shadow: rgba(244, 63, 94, 0.3);">
          <div class="flex flex-col gap-6 md:flex-row md:items-center">
            <div class="flex items-center justify-center flex-shrink-0 w-16 h-16 rounded-2xl bg-gradient-to-br from-brand-rose to-brand-rose/50">
            ...
            <div>
              <h3 class="mb-3 text-2xl font-semibold text-white">Respect</h3>
              <p class="leading-relaxed text-white/50">Pentru organizatorii care construiesc afaceri. Pentru artiștii care creează artă. Pentru fanii care caută experiențe. Pentru toți cei care lucrează să aducă oamenii împreună.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="relative py-32 overflow-hidden bg-dark-850">
    <div class="max-w-6xl px-6 mx-auto lg:px-8">
      <!-- Section Header -->
      <div class="max-w-3xl mx-auto mb-20 text-center reveal">
        <span class="text-sm font-medium tracking-widest uppercase text-brand-violet">Echipa</span>
        <h2 class="mt-4 mb-6 text-4xl font-bold text-white font-display md:text-6xl">Oamenii din <span class="text-gradient">spatele scenei</span></h2>
        <p class="text-xl text-white/60">Experiență în industria evenimentelor combinată cu excelență tehnică</p>
      </div>

      <!-- Team Description -->
      <div class="grid gap-12 mb-16 lg:grid-cols-2">
        <!-- Industry Experience -->
        <div class="p-8 team-card reveal">
          <div class="flex items-center gap-4 mb-6">
            <div class="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-amber to-brand-rose">
              <span class="text-2xl">🎪</span>
            </div>
            <div>
              <h3 class="text-xl font-semibold text-white">Experiență în Evenimente</h3>
              <p class="text-sm text-white/50">De la workshop-uri la festivaluri</p>
            </div>
          </div>
        ...
        <!-- Tech Excellence -->
        <div class="p-8 team-card reveal reveal-delay-1">
          <div class="flex items-center gap-4 mb-6">
            <div class="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-violet to-brand-cyan">
              <span class="text-2xl">⚡</span>
            </div>
            <div>
              <h3 class="text-xl font-semibold text-white">Excelență Tehnică</h3>
              <p class="text-sm text-white/50">Din companii tech de top</p>
            </div>
          </div>
          <p class="leading-relaxed text-white/60">
      ...
      <div class="text-center reveal reveal-delay-2">
        <div class="inline-block px-8 py-6 gradient-border rounded-2xl bg-dark-800/50" style="--dark-800: #13131c;">
          <p class="text-xl font-light text-white md:text-2xl">
            Împreună, creăm platforma de ticketing pe care <span class="font-medium text-gradient">am fi vrut întotdeauna să o folosim.</span>
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="relative py-32 overflow-hidden">
    ...
    <div class="relative max-w-6xl px-6 mx-auto lg:px-8">
      <!-- Section Header -->
      <div class="max-w-3xl mx-auto mb-20 text-center reveal">
        <span class="text-sm font-medium tracking-widest uppercase text-brand-rose">Angajament</span>
        <h2 class="mt-4 mb-6 text-4xl font-bold text-white font-display md:text-6xl">Promisiunile <span class="text-gradient-warm">noastre</span></h2>
      </div>
      ...
      <div class="grid gap-8 md:grid-cols-3">
        ...
        <div class="text-center reveal">
          <div class="flex items-center justify-center w-20 h-20 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-brand-violet to-brand-violet/50 animate-float">
          ...
          <h3 class="mb-4 text-xl font-semibold text-white">Către Organizatori</h3>
        ...
        <div class="text-center reveal reveal-delay-1">
          <div class="flex items-center justify-center w-20 h-20 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-brand-cyan to-brand-cyan/50 animate-float" style="animation-delay: 0.5s;">
          ...
          <h3 class="mb-4 text-xl font-semibold text-white">Către Participanți</h3>
          <p class="leading-relaxed text-white/50">
        ...
        <!-- To Industry -->
        <div class="text-center reveal reveal-delay-2">
          <div class="flex items-center justify-center w-20 h-20 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-brand-green to-brand-green/50 animate-float" style="animation-delay: 1s;">
          ...
          <h3 class="mb-4 text-xl font-semibold text-white">Către Industrie</h3>
          <p class="leading-relaxed text-white/50">
  ...
  <!-- ==================== CONTACT ==================== -->
  <section class="relative py-32 bg-dark-850">
    <div class="max-w-5xl px-6 mx-auto lg:px-8">
      <!-- Section Header -->
      <div class="max-w-3xl mx-auto mb-16 text-center reveal">
        <span class="text-sm font-medium tracking-widest uppercase text-brand-cyan">Contact</span>
        <h2 class="mt-4 mb-6 text-4xl font-bold text-white font-display md:text-5xl">Hai să <span class="text-gradient">vorbim</span></h2>
        <p class="text-lg text-white/60">Suntem aici pentru orice întrebare ai avea</p>
      </div>

      <!-- Contact Cards -->
      <div class="grid gap-6 mb-16 sm:grid-cols-2 lg:grid-cols-4">
        <!-- General -->
        <a href="mailto:hello@tixello.com" class="contact-card reveal" style="--contact-color: rgba(124, 58, 237, 0.5);">
          <div class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-xl bg-brand-violet/20">
          ...
          <h4 class="mb-1 font-medium text-white">Întrebări Generale</h4>
          <p class="text-sm text-brand-violet">hello@tixello.com</p>
        </a>

        <!-- Sales -->
        <a href="mailto:sales@tixello.com" class="contact-card reveal reveal-delay-1" style="--contact-color: rgba(16, 185, 129, 0.5);">
          <div class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-xl bg-brand-green/20">
          ...
          <h4 class="mb-1 font-medium text-white">Vânzări</h4>
          <p class="text-sm text-brand-green">sales@tixello.com</p>
        </a>

        <!-- Support -->
        <a href="mailto:support@tixello.com" class="contact-card reveal reveal-delay-2" style="--contact-color: rgba(6, 182, 212, 0.5);">
          <div class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-xl bg-brand-cyan/20">
            <svg class="w-6 h-6 text-brand-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
          </div>
          <h4 class="mb-1 font-medium text-white">Suport</h4>
          <p class="text-sm text-brand-cyan">support@tixello.com</p>
        </a>

        <!-- Press -->
        <a href="mailto:press@tixello.com" class="contact-card reveal reveal-delay-3" style="--contact-color: rgba(245, 158, 11, 0.5);">
          <div class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-xl bg-brand-amber/20">
          ...
          <h4 class="mb-1 font-medium text-white">Presă</h4>
          <p class="text-sm text-brand-amber">press@tixello.com</p>
        </a>
      </div>

      <!-- Location Note -->
      <div class="text-center reveal">
        <div class="inline-flex items-center gap-3 px-6 py-4 border rounded-2xl bg-white/5 border-white/10">
  ...
  <section class="relative py-32 overflow-hidden">
    ...
    <div class="relative max-w-4xl px-6 mx-auto text-center lg:px-8">
      <h2 class="mb-6 text-5xl font-bold text-white font-display md:text-7xl reveal">
        Alătură-te<br><span class="text-gradient">călătoriei</span>
      </h2>
      <p class="max-w-2xl mx-auto mb-10 text-xl text-white/60 reveal reveal-delay-1">
      ...
      <div class="flex flex-col justify-center gap-4 sm:flex-row reveal reveal-delay-2">
        <a href="<?php echo esc_url(home_url('/signup')); ?>" class="inline-flex items-center justify-center gap-2 px-10 py-4 text-lg font-semibold transition-all duration-300 bg-white rounded-full shadow-xl group text-dark-900 hover:bg-white/90 hover:scale-105">
