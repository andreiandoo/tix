...
<main class="noise font-body bg-dark-900 text-zinc-200 overflow-x-hidden">
      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="reveal">
          ...
          <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-sheets-green/10 border border-sheets-green/20 mb-6">
            ...
            <span class="text-sheets-green text-sm font-medium">Spreadsheet Export</span>
          </div>
          ...
          <p class="text-xl text-white/60 mb-8 leading-relaxed max-w-xl">
            Exportă comenzi, bilete și clienți în <strong class="text-white">Google Sheets</strong>. Sincronizare în timp real, rapoarte programate, dashboard-uri live.
          </p>
          ...
          <div class="grid grid-cols-3 gap-6">
            <div>
              ...
              <div class="text-white/40 text-sm">Sincronizare</div>
            </div>
            <div>
              <div class="text-3xl font-display font-bold text-white">4</div>
              <div class="text-white/40 text-sm">Tipuri export</div>
            </div>
            <div>
              <div class="text-3xl font-display font-bold text-sheets-green">Auto</div>
              <div class="text-white/40 text-sm">Programare</div>
            </div>
          </div>
        </div>
        ...
        <div class="reveal reveal-delay-1">
          <div class="relative" x-data="{
            syncing: false,
            rowCount: 5,
            lastUpdate: 'Acum 2 sec',
            rows: [
              { id: 'ORD-001', email: 'maria@ex.ro', total: '€150', status: 'Plătit' },
              { id: 'ORD-002', email: 'alex@co.ro', total: '€225', status: 'Plătit' },
              { id: 'ORD-003', email: 'elena@biz.ro', total: '€75', status: 'Pending' },
              { id: 'ORD-004', email: 'ion@mail.ro', total: '€300', status: 'Plătit' },
              { id: 'ORD-005', email: 'ana@work.ro', total: '€150', status: 'Plătit' }
            ]
          }" x-init="setInterval(() => {
            syncing = true;
            setTimeout(() => {
              syncing = false;
              rowCount++;
              lastUpdate = 'Acum ' + Math.floor(Math.random() * 5 + 1) + ' sec';
            }, 1000);
          }, 4000)">
            ...
            <div class="bg-dark-800/80 backdrop-blur-xl rounded-2xl border border-sheets-green/20 shadow-2xl overflow-hidden">
              ...
              <div class="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-dark-900/50">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-white text-sm font-medium">Raport Vânzări - Festival 2025</div>
                ...
                <div class="flex items-center gap-2">
                  <div class="flex items-center gap-1" :class="syncing && 'text-sheets-green'">
                    ...
                    <span class="text-xs" :class="syncing ? 'text-sheets-green' : 'text-white/40'" x-text="syncing ? 'Sincronizare...' : lastUpdate"></span>
                  </div>
                </div>
              </div>
              ...
              <div class="overflow-hidden" :class="syncing && 'sync-active'">
                ...
                <div class="flex spreadsheet-header">
                  ...
                  <div class="spreadsheet-cell flex-1 text-white font-medium">Comandă</div>
                  <div class="spreadsheet-cell flex-1 text-white font-medium">Email</div>
                  <div class="spreadsheet-cell flex-1 text-white font-medium">Total</div>
                  <div class="spreadsheet-cell flex-1 text-white font-medium">Status</div>
                </div>
                ...
                <div class="flex spreadsheet-row opacity-50 border-t border-sheets-green/30">
                  ...
                  <div class="spreadsheet-cell flex-1 text-sheets-green/50 italic text-xs">Nouă comandă...</div>
              ...
              <div class="px-4 py-2 border-t border-white/10 bg-dark-900/30 flex items-center justify-between">
                <span class="text-white/40 text-xs" x-text="rowCount + ' rânduri sincronizate'"></span>
            ...
            <div class="absolute -top-4 -right-4 bg-sheets-green rounded-xl px-4 py-3 shadow-xl animate-float z-10">
              <div class="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div class="text-white/70 text-xs">Sync activ</div>
                </div>
              </div>
            </div>
            ...
            <div class="absolute -bottom-4 -left-4 bg-dark-800 rounded-xl px-4 py-3 border border-sheets-green/30 shadow-xl animate-float [animation-delay:1s] z-10">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <div class="text-sheets-green text-sm font-medium">Zilnic 06:00</div>
                  <div class="text-white/40 text-xs">Auto export</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="py-24 relative overflow-hidden" id="functii">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div class="text-center max-w-3xl mx-auto mb-16 reveal">
        <span class="text-sheets-green text-sm font-medium uppercase tracking-widest">Tipuri de Date</span>
        <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">Exportă<br><span class="text-gradient-sheets">orice</span></h2>
        <p class="text-lg text-white/60">Comenzi, bilete, clienți sau analize. Toate datele tale, organizate în spreadsheet-uri.</p>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 reveal">
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-sheets-green/20 hover:border-sheets-green/50 transition-all duration-500">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Comenzi</h3>
          <p class="text-white/50 text-sm mb-4">Detalii comandă, totaluri, status plată, referință client.</p>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-brand-violet/20 hover:border-brand-violet/50 transition-all duration-500">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Bilete</h3>
          <p class="text-white/50 text-sm mb-4">Bilete individuale, participanți, status check-in.</p>
          <div class="flex flex-wrap gap-2">
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-brand-cyan/20 hover:border-brand-cyan/50 transition-all duration-500">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Clienți</h3>
          <p class="text-white/50 text-sm mb-4">Info contact, istoric achiziții, preferințe.</p>
          <div class="flex flex-wrap gap-2">
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-brand-amber/20 hover:border-brand-amber/50 transition-all duration-500">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Evenimente</h3>
          <p class="text-white/50 text-sm mb-4">Detalii eveniment, sumar vânzări, participare.</p>
          <div class="flex flex-wrap gap-2">
  ...
  <section class="py-24 bg-dark-850 relative">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        <!-- Content -->
        <div class="reveal">
          <span class="text-sheets-green text-sm font-medium uppercase tracking-widest">Moduri Sincronizare</span>
          <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">Sincronizare<br><span class="text-gradient-sheets">flexibilă</span></h2>
          <p class="text-lg text-white/60 mb-8">Alege cum și când se sincronizează datele. Real-time pentru dashboard-uri live, programat pentru rapoarte regulate.</p>
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-4 p-4 rounded-xl bg-sheets-green/10 border border-sheets-green/30">
              ...
              <div>
                <span class="text-white font-medium">Real-time</span>
                <p class="text-white/50 text-sm">Date actualizate instant pe măsură ce apar</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 p-4 rounded-xl bg-dark-800/50 border border-white/10">
              ...
              <div>
                <span class="text-white font-medium">Programat</span>
                <p class="text-white/50 text-sm">Export automat: orar, zilnic, săptămânal</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 p-4 rounded-xl bg-dark-800/50 border border-white/10">
              ...
              <div>
                <span class="text-white font-medium">Incremental</span>
                <p class="text-white/50 text-sm">Adaugă doar date noi, fără duplicare</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 p-4 rounded-xl bg-dark-800/50 border border-white/10">
              ...
              <div>
                <span class="text-white font-medium">Full Sync</span>
                <p class="text-white/50 text-sm">Înlocuiește tot cu date proaspete</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="reveal reveal-delay-1">
          <div class="bg-dark-800 rounded-2xl p-6 border border-white/10">
            <div class="flex items-center gap-3 mb-6">
              ...
              <div>
                <div class="text-white font-semibold">Programare Export</div>
                <div class="text-white/40 text-xs">Configurare sincronizare automată</div>
              </div>
            </div>

            <!-- Frequency Options -->
            <div class="space-y-3 mb-6">
              <div class="text-white/40 text-xs uppercase tracking-wider">Frecvență</div>
              <div class="grid grid-cols-4 gap-2">
                <button class="py-2 px-3 rounded-lg bg-dark-900/50 border border-white/10 text-white/60 text-sm hover:border-sheets-green/50 transition-colors">Orar</button>
                <button class="py-2 px-3 rounded-lg bg-sheets-green/20 border border-sheets-green text-sheets-green text-sm font-medium">Zilnic</button>
                <button class="py-2 px-3 rounded-lg bg-dark-900/50 border border-white/10 text-white/60 text-sm hover:border-sheets-green/50 transition-colors">Săptămânal</button>
                <button class="py-2 px-3 rounded-lg bg-dark-900/50 border border-white/10 text-white/60 text-sm hover:border-sheets-green/50 transition-colors">Lunar</button>
              </div>
            </div>

            <!-- Time -->
            <div class="space-y-3 mb-6">
              <div class="text-white/40 text-xs uppercase tracking-wider">Ora</div>
              <div class="flex items-center gap-2">
            ...
            <!-- Scheduled Jobs -->
            <div class="space-y-2">
              <div class="text-white/40 text-xs uppercase tracking-wider">Joburi active</div>
              <div class="p-3 rounded-lg bg-sheets-green/10 border border-sheets-green/30 flex items-center justify-between">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-white text-sm">Comenzi zilnice</span>
                </div>
              ...
              <div class="p-3 rounded-lg bg-dark-900/50 border border-white/10 flex items-center justify-between">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-white/70 text-sm">Sumar săptămânal</span>
                </div>
                <span class="text-white/40 text-xs">Luni 08:00</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="reveal order-2 lg:order-1">
          <div class="bg-dark-800 rounded-2xl p-6 border border-white/10">
            <div class="flex items-center gap-3 mb-6">
              ...
              <div>
                <div class="text-white font-semibold">Mapare Coloane</div>
                <div class="text-white/40 text-xs">Personalizează structura export</div>
              </div>
            </div>
        ...
        <div class="reveal order-1 lg:order-2">
          <span class="text-brand-violet text-sm font-medium uppercase tracking-widest">Personalizare</span>
          <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">Mapare<br><span class="text-gradient-sheets">personalizată</span></h2>
          <p class="text-lg text-white/60 mb-8">Controlezi ce date apar și cum. Redenumește coloanele, schimbă ordinea, selectează exact ce ai nevoie.</p>
          ...
          <div class="space-y-4">
            <div class="flex items-start gap-3">
              ...
              <div>
                <div class="text-white font-medium">Selectează câmpuri</div>
                <p class="text-white/50 text-sm">Alege doar datele relevante pentru raport</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                <div class="text-white font-medium">Redenumește headere</div>
                <p class="text-white/50 text-sm">Nume de coloane în română sau engleză</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                <div class="text-white font-medium">Setează ordinea</div>
                <p class="text-white/50 text-sm">Drag & drop pentru a reordona coloanele</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                <div class="text-white font-medium">Formatare date/numere</div>
                <p class="text-white/50 text-sm">Formate locale pentru date și valute</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="py-24 bg-dark-850 relative">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="text-center max-w-3xl mx-auto mb-16 reveal">
        ...
        <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">Spreadsheet-uri<br><span class="text-gradient animate-shimmer">acționabile</span></h2>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-sheets-green/30 transition-all duration-500 reveal">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Dashboard Vânzări Live</h3>
          <p class="text-white/50 text-sm">Urmărește vânzările în timp real. Grafice care se actualizează automat. Vizibilitate pentru stakeholderi.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-brand-amber/30 transition-all duration-500 reveal reveal-delay-1">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Rapoarte Finance</h3>
          <p class="text-white/50 text-sm">Export zilnic pentru reconciliere. Finance-ul are mereu date proaspete în fiecare dimineață.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-brand-violet/30 transition-all duration-500 reveal reveal-delay-2">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Analiză Marketing</h3>
          <p class="text-white/50 text-sm">Date clienți pentru segmentare. Campanii targetate bazate pe comportament real.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-brand-cyan/30 transition-all duration-500 reveal">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Operațiuni Event Day</h3>
          <p class="text-white/50 text-sm">Liste participanți live. Urmărire check-in în timp real. Monitorizare capacitate.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-brand-rose/30 transition-all duration-500 reveal reveal-delay-1">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Raportare Sponsori</h3>
          <p class="text-white/50 text-sm">Analize complete pentru sponsori. Date participare, demografie, engagement.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-google-blue/30 transition-all duration-500 reveal reveal-delay-2">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Colaborare Echipă</h3>
          <p class="text-white/50 text-sm">Share native în Google Sheets. Finance, marketing, operațiuni - toți pe aceleași date.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="relative reveal">
        ...
        <div class="bg-gradient-to-br from-sheets-green/10 to-sheets-dark/10 rounded-3xl p-8 md:p-12 border border-sheets-green/20">
          ...
          <blockquote class="text-2xl md:text-3xl text-white font-light leading-relaxed mb-8">
            "În fiecare dimineață la 6:00, raportul de vânzări apare <span class="text-gradient-sheets font-semibold">automat în Sheets</span>. Când ajung la birou, dashboard-ul e deja actualizat. Zero muncă manuală."
          </blockquote>
          <div class="flex items-center gap-4">
  ...
  <section class="py-32 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center relative">
      ...
      <p class="text-xl text-white/60 mb-10 max-w-2xl mx-auto reveal reveal-delay-1">Sincronizare real-time, export programat, mapare personalizată. Spreadsheet-uri care lucrează pentru tine.</p>
      ...
      <p class="text-white/30 text-sm mt-8 reveal reveal-delay-3">OAuth 2.0 • Real-time Sync • Export Programat</p>
    </div>
  </section>
