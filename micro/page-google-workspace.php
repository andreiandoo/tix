...
<main class="noise font-body bg-dark-900 text-zinc-200 overflow-x-hidden">
  ...
  <section class="min-h-screen flex items-center pt-20 relative overflow-hidden">
    ...
    <div class="absolute top-32 left-16 w-4 h-4 rounded-full bg-google-blue opacity-30 animate-float"></div>
    <div class="absolute top-48 right-24 w-3 h-3 rounded-full bg-google-red opacity-20 animate-float" style="animation-delay: 0.5s;"></div>
    <div class="absolute bottom-40 left-32 w-5 h-5 rounded-full bg-google-yellow opacity-25 animate-float" style="animation-delay: 1s;"></div>
    <div class="absolute bottom-32 right-40 w-4 h-4 rounded-full bg-google-green opacity-20 animate-float" style="animation-delay: 1.5s;"></div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-20">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="reveal">
          <!-- Badge -->
          <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-google-blue/10 border border-google-blue/20 mb-6">
          ...
          <div class="flex flex-wrap gap-4 mb-12">
            <a href="<?php echo esc_url(home_url('/signup')); ?>" class="group inline-flex items-center gap-2 font-semibold px-8 py-4 rounded-full bg-white text-google-grey hover:bg-gray-100 hover:shadow-glow-google transition-all duration-300">
              <svg class="w-5 h-5" viewBox="0 0 24 24">
                <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
          ...
          <div class="flex items-center gap-6">
            <div class="flex items-center gap-2">
              ...
              <span class="text-white/50 text-sm">Drive</span>
            </div>
            <div class="flex items-center gap-2">
              ...
              <span class="text-white/50 text-sm">Calendar</span>
            </div>
            <div class="flex items-center gap-2">
              ...
              <span class="text-white/50 text-sm">Gmail</span>
            </div>
          </div>
        </div>
        ...
        <div class="reveal reveal-delay-1">
          <div class="relative" x-data="{ activeService: 'drive' }" x-init="setInterval(() => {
            ...
            <!-- Main Card -->
            <div class="bg-dark-800/80 backdrop-blur-xl rounded-3xl p-6 border border-google-blue/20 shadow-2xl">
              <!-- Header -->
              ...
              <div class="flex gap-2 mb-6">
                <button
                  ...
                  class="flex-1 py-2 px-3 rounded-lg border transition-all text-sm font-medium"
                >
              ...
              <div x-show="activeService === 'drive'" x-transition class="space-y-3">
                <div class="flex items-center gap-3 p-3 rounded-lg bg-dark-900/50">
                  <div class="file-icon folder flex items-center justify-center">
                ...
                <div class="flex items-center gap-3 p-3 rounded-lg bg-dark-900/50">
                  <div class="file-icon xlsx flex items-center justify-center">
              ...
              <div x-show="activeService === 'calendar'" x-transition class="space-y-3">
                <div class="calendar-event p-3 rounded-lg">
                  <div class="flex items-center justify-between mb-1">
                    <span class="text-calendar-event font-medium text-sm">Summer Festival 2025</span>
                    <span class="text-white/40 text-xs">15 Iulie</span>
                  </div>
                  <div class="text-white/60 text-xs">18:00 - 23:00 • Arena Parc Central</div>
                  <div class="flex items-center gap-2 mt-2">
                    <div class="flex -space-x-2">
                      <div class="w-5 h-5 rounded-full bg-google-blue flex items-center justify-center text-white text-xs">M</div>
            ...
            <div class="absolute -top-4 -right-4 bg-dark-800 rounded-xl px-4 py-3 border border-google-green/30 shadow-xl animate-float z-10">
              <div class="flex items-center gap-2">
                <div class="w-8 h-8 rounded-lg bg-google-green/20 flex items-center justify-center">
  ...
  <!-- ==================== SERVICES GRID ==================== -->
  <section class="py-24 relative overflow-hidden" id="servicii">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <!-- Google Drive -->
        <div class="service-card drive feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-google-blue/20 hover:border-google-blue/50 transition-all duration-500 reveal">
          <div class="w-16 h-16 rounded-2xl bg-google-blue/10 flex items-center justify-center mb-6">
        ...
        <!-- Google Calendar -->
        <div class="service-card calendar feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-calendar-event/20 hover:border-calendar-event/50 transition-all duration-500 reveal reveal-delay-1">
          <div class="w-16 h-16 rounded-2xl bg-calendar-event/10 flex items-center justify-center mb-6">
            <svg class="w-8 h-8" viewBox="0 0 24 24">
        ...
        <!-- Gmail -->
        <div class="service-card gmail feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-gmail-primary/20 hover:border-gmail-primary/50 transition-all duration-500 reveal reveal-delay-2">
          <div class="w-16 h-16 rounded-2xl bg-gmail-primary/10 flex items-center justify-center mb-6">
            <svg class="w-8 h-8" viewBox="0 0 24 24">
      ...
      <div class="max-w-4xl mx-auto reveal">
        <div class="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div class="text-center">
            <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-brand-violet to-brand-cyan flex items-center justify-center mx-auto mb-4">
          ...
          <!-- Google -->
          <div class="text-center">
            <div class="google-ring mx-auto mb-4" style="width: 80px; height: 80px;">
              <div class="google-ring-inner">
                <svg class="w-8 h-8" viewBox="0 0 24 24">
                  <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                  <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
            ...
            <div class="text-white font-semibold">Google Workspace</div>
            <div class="text-white/40 text-sm">Drive • Calendar • Gmail</div>
          </div>
        </div>

        <!-- Data Types -->
        <div class="grid md:grid-cols-4 gap-4 mt-12">
          <div class="p-4 rounded-xl bg-dark-800/50 border border-google-blue/20 text-center">
          ...
          <div class="p-4 rounded-xl bg-dark-800/50 border border-calendar-event/20 text-center">
          ...
          <div class="p-4 rounded-xl bg-dark-800/50 border border-gmail-primary/20 text-center">
          ...
          <div class="p-4 rounded-xl bg-dark-800/50 border border-google-green/20 text-center">
  ...
  <section class="py-24 relative">
    <div class="max-w-4xl mx-auto px-6 lg:px-8">
      <div class="relative reveal">
        ...
        <div class="bg-gradient-to-br from-google-blue/10 via-google-green/10 to-google-yellow/10 rounded-3xl p-8 md:p-12 border border-google-blue/20">
