...
<div class="noise font-body bg-dark-900 text-zinc-200 overflow-x-hidden">
      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="reveal">
          ...
          <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-netopia-teal/10 border border-netopia-teal/20 mb-6">
            ...
            <span class="text-netopia-teal text-sm font-medium">Procesator #1 în România</span>
          </div>

          <!-- Heading -->
          <h1 class="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.1]">
            Plăți<br><span class="text-gradient-netopia">românești</span>
          </h1>

          <!-- Description -->
          <p class="text-xl text-white/60 mb-8 leading-relaxed max-w-xl">
            <strong class="text-white">Netopia</strong> - procesatorul de plăți de încredere, cunoscut de milioane de români. Carduri, transferuri bancare, rate. <strong class="text-white">Conversii mai mari</strong> datorită familiarității.
          </p>
          ...
          <div class="grid grid-cols-3 gap-6">
            <div>
              ...
              <div class="text-white/40 text-sm">Ani experiență</div>
            </div>
            <div>
              <div class="text-3xl font-display font-bold text-white">RON</div>
              <div class="text-white/40 text-sm">Valută nativă</div>
            </div>
            <div>
          ...
          <div class="relative" x-data="{
            ...
            <div class="bg-dark-800/80 backdrop-blur-xl rounded-3xl p-6 border border-netopia-teal/20 shadow-2xl">
              ...
              <div class="flex items-center justify-between mb-6">
                ...
                <div class="trust-badge px-3 py-1 rounded-full flex items-center gap-1">
                  ...
                  <span class="text-netopia-teal text-xs font-medium">Securizat</span>
                </div>
              </div>
              ...
              <div class="bg-dark-900/50 rounded-xl p-4 mb-6">
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-right">
                    <div class="text-white/40 text-xs">2 bilete</div>
              ...
              <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-2">
                  ...
                  <span :class="step >= 1 ? 'text-white' : 'text-white/40'" class="text-sm">Detalii</span>
                </div>
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span :class="step >= 3 ? 'text-brand-green' : 'text-white/40'" class="text-sm">Confirmat</span>
                </div>
              </div>
              ...
              <div x-show="step === 1" x-transition class="space-y-4">
                <div class="bg-dark-900/50 rounded-xl p-4 border border-white/10">
                  <div class="text-white/40 text-xs uppercase tracking-wider mb-2">Număr card</div>
                  <div class="flex items-center gap-3">
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div class="bg-dark-900/50 rounded-xl p-4 border border-white/10">
                    <div class="text-white/40 text-xs uppercase tracking-wider mb-2">Expirare</div>
                    <span class="text-white font-mono">12/28</span>
                  </div>
                  <div class="bg-dark-900/50 rounded-xl p-4 border border-white/10">
                    <div class="text-white/40 text-xs uppercase tracking-wider mb-2">CVV</div>
              ...
              <div x-show="step === 2" x-transition class="text-center py-8">
                <div class="secure-3d inline-flex items-center gap-3 px-6 py-3 rounded-xl text-white mb-4">
                  ...
                  <span class="font-semibold">Verificare 3D Secure</span>
                </div>
                <div x-show="processing" class="flex items-center justify-center gap-2 text-white/60">
                  ...
                  <span>Se verifică cu banca ta...</span>
                </div>
                <div x-show="!processing" class="text-white/60 text-sm">Redirecționare către bancă...</div>
              </div>
              ...
              <div x-show="step === 3" x-transition class="text-center py-8">
                ...
                <div class="text-brand-green font-semibold text-lg mb-2">Plată Confirmată!</div>
                <div class="text-white/40 text-sm">Tranzacție #TXN-2025-001234</div>
              </div>
            ...
            <div class="absolute -top-8 -right-8 w-56 ro-card p-4 shadow-card-ro animate-float z-10">
              ...
              <div class="flex justify-between items-end">
                <div>
                  <div class="text-white/40 text-[10px]">TITULAR</div>
                  <div class="text-white/80 text-xs">ION POPESCU</div>
                </div>
                <div class="text-right">
                  <div class="text-white/40 text-[10px]">EXPIRARE</div>
            ...
            <div class="absolute -bottom-4 -left-4 bg-dark-800 rounded-xl px-4 py-3 border border-netopia-teal/30 shadow-xl animate-float [animation-delay:1s] z-10">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <div class="text-netopia-teal text-sm font-medium">15+ ani</div>
                  <div class="text-white/40 text-xs">pe piața RO</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="py-24 relative overflow-hidden" id="metode">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      ...
      <div class="text-center max-w-3xl mx-auto mb-16 reveal">
        <span class="text-netopia-teal text-sm font-medium uppercase tracking-widest">Metode de Plată</span>
        <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">Toate cardurile<br><span class="text-gradient-netopia">românești</span></h2>
        <p class="text-lg text-white/60">Visa, Mastercard, Maestro și cardurile locale ale băncilor românești. Plus transferuri bancare.</p>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal">
          ...
          <p class="text-white/50 text-sm">Credit, Debit, Electron. Toate cardurile Visa emise în România.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal reveal-delay-1">
          ...
          <p class="text-white/50 text-sm">Credit și Debit. Toate băncile românești partenere.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal reveal-delay-2">
          ...
          <p class="text-white/50 text-sm">Carduri de debit pentru plăți imediate din cont.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal reveal-delay-3">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Transfer Bancar</h3>
          <p class="text-white/50 text-sm">Direct din contul bancar pentru clienții care preferă non-card.</p>
        </div>
      </div>
      ...
      <div class="mt-12 reveal">
        <div class="text-center mb-6">
          <span class="text-white/40 text-sm">Carduri emise de toate băncile românești majore</span>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="reveal">
          ...
          <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">3D Secure<br><span class="text-gradient animate-shimmer">obligatoriu</span></h2>
          <p class="text-lg text-white/60 mb-8">Fiecare tranzacție cu cardul trece prin verificarea 3D Secure. Banca clientului autentifică plata - protecție maximă pentru tine și clienții tăi.</p>
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-4 p-4 rounded-xl bg-dark-800/50 border border-brand-green/20">
              ...
              <div>
                <div class="flex items-center gap-2">
                  <span class="text-white font-semibold">Protecție Răspundere</span>
                  <span class="px-2 py-0.5 rounded-full bg-brand-green/20 text-brand-green text-xs">Activă</span>
                </div>
                <p class="text-white/50 text-sm">Liability shift către bancă pentru tranzacțiile autentificate</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 p-4 rounded-xl bg-dark-800/50 border border-white/10">
              ...
              <div>
                <span class="text-white font-semibold">Detectare Fraudă</span>
                <p class="text-white/50 text-sm">Monitorizare automată a tranzacțiilor suspecte</p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4 p-4 rounded-xl bg-dark-800/50 border border-white/10">
              ...
              <div>
                <span class="text-white font-semibold">PCI DSS Compliant</span>
                <p class="text-white/50 text-sm">Datele cardului nu ajung pe serverele tale</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="reveal reveal-delay-1">
          <div class="bg-dark-800 rounded-2xl p-6 border border-white/10">
            <div class="flex items-center gap-3 mb-6">
              ...
              <div>
                <div class="text-white font-semibold">Flux 3D Secure</div>
                <div class="text-white/40 text-xs">Autentificare în 3 pași</div>
              </div>
            </div>
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center gap-4 p-3 rounded-lg bg-dark-900/50">
                ...
                <div class="flex-1">
                  <div class="text-white font-medium">Client introduce cardul</div>
                  <div class="text-white/40 text-sm">Pe pagina securizată Netopia</div>
                </div>
              ...
              <div class="flex items-center gap-4 p-3 rounded-lg bg-romania-blue/10 border border-romania-blue/30">
                ...
                <div class="flex-1">
                  <div class="text-white font-medium">Redirecționare către bancă</div>
                  <div class="text-white/40 text-sm">Autentificare SMS/Token/App</div>
                </div>
              ...
              <div class="flex items-center gap-4 p-3 rounded-lg bg-brand-green/10 border border-brand-green/30">
                ...
                <div class="flex-1">
                  <div class="text-brand-green font-medium">Tranzacție confirmată</div>
                  <div class="text-white/40 text-sm">Webhook instant către sistemul tău</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <section class="py-24 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <!-- Section Header -->
      <div class="text-center max-w-3xl mx-auto mb-16 reveal">
        <span class="text-netopia-teal text-sm font-medium uppercase tracking-widest">Statusuri Tranzacție</span>
        <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">Urmărește<br><span class="text-gradient-netopia">fiecare plată</span></h2>
        <p class="text-lg text-white/60">Webhook-uri în timp real pentru toate schimbările de status. Știi imediat ce se întâmplă.</p>
      </div>
      ...
      <div class="max-w-4xl mx-auto reveal">
        <div class="grid md:grid-cols-4 gap-4">
          ...
          <div class="bg-dark-800/50 rounded-2xl p-6 border border-white/10 text-center">
            ...
            <span class="status-pending px-3 py-1 rounded-full text-xs font-medium">În Așteptare</span>
            <div class="mt-3 text-white/50 text-sm">Cod: 0</div>
            <p class="text-white/40 text-xs mt-2">Plată inițiată, se așteaptă finalizarea</p>
          </div>
          ...
          <div class="bg-dark-800/50 rounded-2xl p-6 border border-netopia-teal/30 text-center relative overflow-hidden">
            ...
            <div class="relative">
              ...
              <span class="status-confirmed px-3 py-1 rounded-full text-xs font-medium">Confirmat</span>
              <div class="mt-3 text-white/50 text-sm">Cod: 1</div>
              <p class="text-white/40 text-xs mt-2">Plată reușită, fonduri securizate</p>
            </div>
          </div>
          ...
          <div class="bg-dark-800/50 rounded-2xl p-6 border border-white/10 text-center">
            ...
            <span class="status-cancelled px-3 py-1 rounded-full text-xs font-medium">Anulat</span>
            <div class="mt-3 text-white/50 text-sm">Cod: 4</div>
            <p class="text-white/40 text-xs mt-2">Anulat de client sau timeout</p>
          </div>
          ...
          <div class="bg-dark-800/50 rounded-2xl p-6 border border-white/10 text-center">
            ...
            <span class="status-credited px-3 py-1 rounded-full text-xs font-medium">Creditat</span>
            <div class="mt-3 text-white/50 text-sm">Cod: 5</div>
            <p class="text-white/40 text-xs mt-2">Rambursare procesată</p>
          </div>
        </div>
        ...
        <div class="mt-8 text-center">
          <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-dark-800/50 border border-white/10">
            ...
            <span class="text-white/60 text-sm">Notificări webhook în timp real pentru fiecare schimbare de status</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 bg-dark-850 relative">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="text-center max-w-3xl mx-auto mb-16 reveal">
        ...
        <h2 class="font-display text-4xl md:text-5xl font-bold text-white mt-4 mb-6">Perfect pentru<br><span class="text-gradient animate-shimmer">piața românească</span></h2>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Evenimente Românești</h3>
          <p class="text-white/50 text-sm">Conversii mai mari când clienții văd Netopia - brand local de încredere pe care îl cunosc.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal reveal-delay-1">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Festivaluri Locale</h3>
          <p class="text-white/50 text-sm">Procesează mii de tranzacții în perioadele de vârf. Infrastructura Netopia scalează automat.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal reveal-delay-2">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Corporate România</h3>
          <p class="text-white/50 text-sm">Transferuri bancare pentru companiile românești care preferă plăți directe.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Artiști Români</h3>
          <p class="text-white/50 text-sm">Procesare familiară pentru fanii care cumpără bilete la concertele artiștilor locali.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal reveal-delay-1">
          ...
          <p class="text-white/50 text-sm">Afișează prețuri în EUR cu conversie automată la RON în checkout.</p>
        </div>
        ...
        <div class="feature-card relative bg-dark-800/50 rounded-2xl p-6 border border-white/10 hover:border-netopia-teal/30 transition-all duration-500 reveal reveal-delay-2">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Plăți în Rate</h3>
          <p class="text-white/50 text-sm">Pachete VIP accesibile prin parteneriatele Netopia cu băncile românești.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="relative reveal">
        ...
        <div class="bg-gradient-to-br from-netopia-teal/10 to-netopia-mint/10 rounded-3xl p-8 md:p-12 border border-netopia-teal/20">
          ...
          <blockquote class="text-2xl md:text-3xl text-white font-light leading-relaxed mb-8">
            "Când am trecut la Netopia, <span class="text-gradient-netopia font-semibold">rata de abandon</span> la checkout a scăzut cu 28%. Românii au încredere în brand - îl văd peste tot online."
          </blockquote>
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <div class="text-white/50">Event Manager, SAGA Festival</div>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="py-32 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-6 lg:px-8 text-center relative">
      <h2 class="font-display text-5xl md:text-7xl font-bold text-white mb-6 reveal">Conectează<br><span class="text-gradient-netopia">Netopia</span></h2>
      <p class="text-xl text-white/60 mb-10 max-w-2xl mx-auto reveal reveal-delay-1">Procesatorul de încredere pentru milioane de români. Carduri locale, 3D Secure, decontare rapidă.</p>
      ...
      <p class="text-white/30 text-sm mt-8 reveal reveal-delay-3">15+ ani experiență • 3D Secure obligatoriu • Decontare 1-3 zile</p>
    </div>
  </section>
</div>
