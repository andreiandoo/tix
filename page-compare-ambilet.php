 ...
 *
 * Comparison page: Tixello vs amBilet
 *
 * @package Tixello
 */
...
<main class="bg-zinc-950 text-zinc-200 antialiased">
    ...
    <!-- ==================== HERO SECTION ==================== -->
    <section class="relative overflow-hidden pt-24 sm:pt-32 pb-16 sm:pb-24 bg-zinc-950">
        <!-- Background effects -->
        ...
        <div class="absolute top-32 left-10 w-20 h-20 rounded-full bg-violet-500/10 blur-2xl animate-float"></div>
        <div class="absolute top-48 right-20 w-32 h-32 rounded-full bg-cyan-500/10 blur-2xl animate-float-delayed"></div>
        <div class="absolute bottom-20 left-1/4 w-24 h-24 rounded-full bg-fuchsia-500/10 blur-2xl animate-float"></div>

        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

            <!-- Breadcrumb -->
            <div class="flex items-center gap-2 text-sm text-white/40 mb-8 animate-fade-in">
                <a href="<?php echo home_url(); ?>" class="hover:text-white/60 transition-colors"><?php echo esc_html($t['breadcrumb_home']); ?></a>
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
                <a href="<?php echo home_url('/compare'); ?>" class="hover:text-white/60 transition-colors"><?php echo esc_html($t['breadcrumb_comparisons']); ?></a>
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
                <span class="text-white/60"><?php echo esc_html($competitor['name']); ?></span>
            </div>

            <!-- VS Header -->
            <div class="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-12 mb-12 animate-fade-in-up">
                <div class="flex items-center gap-4">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-violet-500/20">
                        <span class="text-white font-black text-2xl sm:text-3xl">T</span>
                    </div>
                    <div class="text-left">
                        <p class="text-2xl sm:text-3xl font-bold text-white">Tixello</p>
                        <p class="text-sm text-emerald-400"><?php echo esc_html($t['platform_b2b']); ?></p>
                    </div>
                </div>

                <div class="animate-vs-pulse w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-violet-600/20 to-cyan-600/20 border border-violet-500/30 flex items-center justify-center">
                    <span class="text-xl sm:text-2xl font-black text-white"><?php echo esc_html($t['vs']); ?></span>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="text-left">
                        <p class="text-2xl sm:text-3xl font-bold text-white"><?php echo esc_html($competitor['name']); ?></p>
            ...
            <div class="text-center max-w-4xl mx-auto">
                <h1 class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black text-white leading-tight mb-6 animate-fade-in-up">
                ...
                <p class="text-lg sm:text-xl text-white/60 max-w-3xl mx-auto mb-8 animate-fade-in-up">
                    <?php echo $t['hero_description']; ?>
                    <span class="text-white font-medium"><?php echo esc_html($t['hero_stats']); ?></span>
                </p>

                <!-- Quick stats -->
                <div class="flex flex-wrap items-center justify-center gap-6 sm:gap-10 mb-10 animate-fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up">
                    ...
                    <a href="#comparison" class="w-full sm:w-auto px-8 py-4 rounded-xl border border-white/20 text-white font-semibold hover:bg-white/5 hover:border-white/30 transition-all"><?php echo esc_html($t['cta_offer']); ?></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative py-16 sm:py-24 bg-zinc-900/30 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

            <div class="text-center mb-12">
                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3"><?php echo esc_html($t['quick_comparison_title']); ?></h2>
                <p class="text-white/50 max-w-3xl mx-auto"><?php echo esc_html($t['quick_comparison_desc']); ?></p>
            </div>

            <div class="grid md:grid-cols-3 gap-6">
                <!-- Cost Card -->
                <div class="relative group">
                    <div class="absolute inset-0 bg-gradient-to-br from-emerald-500/20 to-emerald-600/5 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-emerald-500/30 transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['card_cost']); ?></h3>
                        <p class="text-sm text-white/50 mb-4">Tixello vs <?php echo esc_html($competitor['name']); ?></p>
                        <div class="space-y-3">
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                                <span class="text-sm text-white/70">Tixello: 1-3% transparent</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5 text-fuchsia-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/></svg>
                ...
                <!-- Cashflow Card -->
                <div class="relative group">
                    <div class="absolute inset-0 bg-gradient-to-br from-violet-500/20 to-violet-600/5 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-violet-500/30 transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['card_cashflow']); ?></h3>
                        <p class="text-sm text-white/50 mb-4">Tixello vs <?php echo esc_html($competitor['name']); ?></p>
                        <div class="space-y-3">
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                ...
                <!-- Fiscalitate Card -->
                <div class="relative group">
                    <div class="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-cyan-600/5 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-cyan-500/30 transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['card_fiscal']); ?></h3>
                        <p class="text-sm text-white/50 mb-4">Tixello vs <?php echo esc_html($competitor['name']); ?></p>
                        <div class="space-y-3">
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                            ...
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5 text-white/30 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>
    ...
    <!-- ==================== DEMO CTA ==================== -->
    <section class="relative py-16 bg-zinc-950 border-t border-white/5">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4"><?php echo esc_html($t['demo_title']); ?></h2>
            <p class="text-white/50 mb-8 max-w-2xl mx-auto"><?php echo esc_html($t['demo_desc']); ?></p>
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="#demo" class="px-8 py-4 rounded-xl bg-gradient-to-r from-violet-600 to-violet-500 hover:from-violet-500 hover:to-violet-400 text-white font-semibold shadow-lg shadow-violet-500/30 transition-all"><?php echo esc_html($t['cta_demo']); ?></a>
                <a href="#contact" class="px-8 py-4 rounded-xl border border-white/20 text-white font-semibold hover:bg-white/5 transition-all"><?php echo esc_html($t['cta_offer']); ?></a>
            </div>
        </div>
    </section>

    <!-- ==================== VERDICT SECTION ==================== -->
    <section class="relative py-20 sm:py-28 bg-zinc-900/30 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl font-bold text-white mb-4"><?php echo esc_html($t['verdict_title']); ?></h2>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10">
                    ...
                    <p class="text-white/60 mb-6 leading-relaxed"><?php echo $content['verdict_text']; ?></p>
                ...
                <!-- Tixello -->
                <div class="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-cyan-500/5 border border-emerald-500/20">
                    <div class="flex items-center gap-3 mb-6">
    ...
    <section id="comparison" class="relative py-20 sm:py-28 bg-zinc-950 border-t border-white/5">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
                    <?php echo esc_html($t['detailed_title']); ?> <span class="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent"><?php echo esc_html($t['detailed_title_gradient']); ?></span>
                </h2>
            </div>
            ...
            <div class="space-y-8">
                ...
                <div class="grid lg:grid-cols-2 gap-6 items-stretch">
                    <!-- Tixello Side -->
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 group hover:border-emerald-500/40 transition-all">
                        <div class="absolute top-4 right-4">
                            <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-emerald-500/20 text-emerald-400 text-xs font-medium">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_1_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_1_tixello']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium">1-3% <?php echo $lang === 'en' ? 'commission' : 'comision'; ?></span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium"><?php echo $lang === 'en' ? 'Direct payout' : 'Payout direct'; ?></span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium"><?php echo $lang === 'en' ? 'No subscription' : 'Fără abonament'; ?></span>
                        </div>
                    </div>
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_1_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_1_competitor']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium"><?php echo $lang === 'en' ? 'Percentages not public' : 'Procente nepublice'; ?></span>
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium"><?php echo $lang === 'en' ? 'Payout unknown' : 'Payout necunoscut'; ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-6 items-stretch">
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 group hover:border-emerald-500/40 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_2_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_2_tixello']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium"><?php echo $lang === 'en' ? 'Dedicated admin' : 'Admin dedicat'; ?></span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium"><?php echo $lang === 'en' ? 'Own GTM' : 'GTM propriu'; ?></span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium">Self-hosted</span>
                        </div>
                    </div>
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_2_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_2_competitor']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium">Marketplace</span>
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium"><?php echo $lang === 'en' ? 'Mandatory contract' : 'Contract obligatoriu'; ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-6 items-stretch">
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 group hover:border-emerald-500/40 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_3_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_3_tixello']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium">eFactura</span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium">Multi-processor</span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium">Chat live</span>
                        </div>
                    </div>
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_3_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_3_competitor']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium"><?php echo $lang === 'en' ? 'Refund via processor' : 'Refund via procesator'; ?></span>
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium"><?php echo $lang === 'en' ? 'eFactura not communicated' : 'eFactura necomunicată'; ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-6 items-stretch">
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/20 group hover:border-emerald-500/40 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_4_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_4_tixello']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium">Seat maps</span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium"><?php echo $lang === 'en' ? 'Promo codes' : 'Coduri promo'; ?></span>
                            <span class="px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-medium"><?php echo $lang === 'en' ? 'Live reports' : 'Rapoarte live'; ?></span>
                        </div>
                    </div>
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <h3 class="text-xl font-bold text-white mb-3"><?php echo esc_html($t['compare_4_title']); ?></h3>
                        <p class="text-white/60 leading-relaxed mb-4"><?php echo $content['compare_4_competitor']; ?></p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium">e-ticket PDF</span>
                            <span class="px-3 py-1 rounded-full bg-white/5 text-white/40 text-xs font-medium"><?php echo $lang === 'en' ? 'Optional courier' : 'Curier opțional'; ?></span>
                        </div>
                    </div>
                </div>
    ...
    <!-- ==================== BENEFITS SECTION ==================== -->
    <section class="relative py-20 sm:py-28 bg-zinc-900/30 border-t border-white/5 overflow-hidden">

        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute top-1/2 left-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl -translate-y-1/2"></div>
            <div class="absolute top-1/2 right-0 w-64 h-64 bg-cyan-500/10 rounded-full blur-3xl -translate-y-1/2"></div>
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl font-bold text-white mb-4"><?php echo esc_html($t['benefits_title']); ?></h2>
            </div>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                ...
                <div class="group p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-emerald-500/30 hover:bg-white/[0.04] transition-all">
                    ...
                    <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['benefit_1_title']); ?></h3>
                    <p class="text-sm text-white/50 leading-relaxed"><?php echo esc_html($t['benefit_1_desc']); ?></p>
                </div>
                ...
                <div class="group p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-emerald-500/30 hover:bg-white/[0.04] transition-all">
                    ...
                    <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['benefit_2_title']); ?></h3>
                    <p class="text-sm text-white/50 leading-relaxed"><?php echo esc_html($t['benefit_2_desc']); ?></p>
                </div>
                ...
                <div class="group p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-emerald-500/30 hover:bg-white/[0.04] transition-all">
                    ...
                    <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['benefit_3_title']); ?></h3>
                    <p class="text-sm text-white/50 leading-relaxed"><?php echo esc_html($t['benefit_3_desc']); ?></p>
                </div>
                ...
                <div class="group p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-emerald-500/30 hover:bg-white/[0.04] transition-all">
                    ...
                    <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['benefit_4_title']); ?></h3>
                    <p class="text-sm text-white/50 leading-relaxed"><?php echo esc_html($t['benefit_4_desc']); ?></p>
                </div>
                ...
                <div class="group p-6 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-emerald-500/30 hover:bg-white/[0.04] transition-all sm:col-span-2 lg:col-span-1">
                    ...
                    <h3 class="text-lg font-bold text-white mb-2"><?php echo esc_html($t['benefit_5_title']); ?></h3>
                    <p class="text-sm text-white/50 leading-relaxed"><?php echo esc_html($t['benefit_5_desc']); ?></p>
                </div>
    ...
    <!-- ==================== COMPARISON TABLE ==================== -->
    <section class="relative py-20 sm:py-28 bg-zinc-950 border-t border-white/5">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">

            <div class="text-center mb-12">
                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-3"><?php echo esc_html($t['table_title']); ?> <?php echo esc_html($competitor['name']); ?></h2>
            </div>

            <div class="rounded-2xl border border-white/10 overflow-hidden bg-white/[0.02]">
                <div class="grid grid-cols-3 bg-white/[0.03]">
                    <div class="p-4 sm:p-5 text-sm font-semibold text-white/40 border-r border-white/5"><?php echo esc_html($t['table_criterion']); ?></div>
                    <div class="p-4 sm:p-5 text-center border-r border-white/5">
                        <div class="flex items-center justify-center gap-2">
                            <div class="w-6 h-6 rounded bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center"><span class="text-white font-bold text-xs">T</span></div>
                ...
                <div class="divide-y divide-white/5">
                    <div class="grid grid-cols-3 hover:bg-white/[0.02] transition-colors">
                        <div class="p-4 sm:p-5 text-sm text-white/70 border-r border-white/5"><?php echo esc_html($t['table_cost']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-emerald-400 border-r border-white/5 bg-emerald-500/5 text-center"><?php echo esc_html($content['table']['cost_tixello']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-white/50 text-center"><?php echo esc_html($content['table']['cost_competitor']); ?></div>
                    </div>
                    <div class="grid grid-cols-3 hover:bg-white/[0.02] transition-colors">
                        <div class="p-4 sm:p-5 text-sm text-white/70 border-r border-white/5"><?php echo esc_html($t['table_cashflow']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-emerald-400 border-r border-white/5 bg-emerald-500/5 text-center"><?php echo esc_html($content['table']['cashflow_tixello']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-white/50 text-center"><?php echo esc_html($content['table']['cashflow_competitor']); ?></div>
                    </div>
                    <div class="grid grid-cols-3 hover:bg-white/[0.02] transition-colors">
                        <div class="p-4 sm:p-5 text-sm text-white/70 border-r border-white/5"><?php echo esc_html($t['table_admin']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-emerald-400 border-r border-white/5 bg-emerald-500/5 text-center"><?php echo esc_html($content['table']['admin_tixello']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-white/50 text-center"><?php echo esc_html($content['table']['admin_competitor']); ?></div>
                    </div>
                    <div class="grid grid-cols-3 hover:bg-white/[0.02] transition-colors">
                        <div class="p-4 sm:p-5 text-sm text-white/70 border-r border-white/5"><?php echo esc_html($t['table_delivery']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-emerald-400 border-r border-white/5 bg-emerald-500/5 text-center"><?php echo esc_html($content['table']['delivery_tixello']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-white/50 text-center"><?php echo esc_html($content['table']['delivery_competitor']); ?></div>
                    </div>
                    <div class="grid grid-cols-3 hover:bg-white/[0.02] transition-colors">
                        <div class="p-4 sm:p-5 text-sm text-white/70 border-r border-white/5"><?php echo esc_html($t['table_fiscal']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-emerald-400 border-r border-white/5 bg-emerald-500/5 text-center"><?php echo esc_html($content['table']['fiscal_tixello']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-white/50 text-center"><?php echo esc_html($content['table']['fiscal_competitor']); ?></div>
                    </div>
                    <div class="grid grid-cols-3 hover:bg-white/[0.02] transition-colors">
                        <div class="p-4 sm:p-5 text-sm text-white/70 border-r border-white/5"><?php echo esc_html($t['table_refund']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-emerald-400 border-r border-white/5 bg-emerald-500/5 text-center"><?php echo esc_html($content['table']['refund_tixello']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-white/50 text-center"><?php echo esc_html($content['table']['refund_competitor']); ?></div>
                    </div>
                    <div class="grid grid-cols-3 hover:bg-white/[0.02] transition-colors">
                        <div class="p-4 sm:p-5 text-sm text-white/70 border-r border-white/5"><?php echo esc_html($t['table_sla']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-emerald-400 border-r border-white/5 bg-emerald-500/5 text-center"><?php echo esc_html($content['table']['sla_tixello']); ?></div>
                        <div class="p-4 sm:p-5 text-sm text-white/50 text-center"><?php echo esc_html($content['table']['sla_competitor']); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="relative py-20 sm:py-28 bg-zinc-900/30 border-t border-white/5">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl font-bold text-white mb-4"><?php echo esc_html($t['faq_title']); ?> <?php echo esc_html($competitor['name']); ?></h2>
            </div>

            <div class="space-y-4" x-data="{ open: 1 }">
                <?php foreach ($content['faq'] as $index => $faq) : $num = $index + 1; ?>
                <div class="rounded-2xl border border-white/10 overflow-hidden transition-all" :class="open === <?php echo $num; ?> ? 'bg-white/[0.03]' : 'bg-white/[0.01] hover:bg-white/[0.02]'">
                    <button @click="open = open === <?php echo $num; ?> ? null : <?php echo $num; ?>" class="w-full flex items-center justify-between p-6 text-left">
                        <span class="font-semibold text-white pr-4"><?php echo esc_html($faq['q']); ?></span>
                        <svg class="w-5 h-5 text-white/50 flex-shrink-0 transition-transform duration-300" :class="open === <?php echo $num; ?> ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
    ...
    <section class="relative py-16 bg-zinc-950 border-t border-white/5 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
            <h3 class="text-lg font-semibold text-white mb-2"><?php echo esc_html($t['carousel_title']); ?></h3>
        </div>
                ...
                <div class="flex animate-scroll-x gap-4 hover:[animation-play-state:paused]">
                    ...
                    <a href="<?php echo home_url('/compare/' . $item['slug']); ?>" class="flex-shrink-0 w-56 p-4 rounded-xl bg-white/[0.03] border border-white/10 hover:border-violet-500/30 hover:bg-white/[0.05] transition-all group">
                        <div class="flex items-center gap-3 mb-2">
                            <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center"><span class="text-white font-bold text-xs">T</span></div>
                        ...
                        <p class="text-sm font-medium text-white group-hover:text-violet-400 transition-colors"><?php echo esc_html($item['name']); ?></p>
                    </a>
                    <?php
                        endforeach;
                    endfor;
    ...
    <!-- ==================== FINAL CTA ==================== -->
    <section id="demo" class="relative py-24 sm:py-32 bg-gradient-to-b from-zinc-900/50 to-zinc-950 border-t border-white/5 overflow-hidden">
        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-px bg-gradient-to-r from-transparent via-violet-500/30 to-transparent"></div>
            <div class="absolute top-1/2 left-1/4 w-64 h-64 bg-violet-600/20 rounded-full blur-3xl"></div>
            <div class="absolute top-1/2 right-1/4 w-64 h-64 bg-cyan-600/20 rounded-full blur-3xl"></div>
        </div>

        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-violet-500/10 to-cyan-500/10 border border-violet-500/20 mb-8">
            ...
            <h2 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                ...
                <span class="block bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent"><?php echo esc_html($t['final_title_gradient']); ?></span>
            </h2>

            <p class="text-lg sm:text-xl text-white/50 mb-10 max-w-2xl mx-auto"><?php echo esc_html($t['final_desc']); ?></p>

            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                <a href="<?php echo home_url('/demo'); ?>" class="group relative w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-5 rounded-2xl bg-gradient-to-r from-violet-600 to-cyan-600 text-white font-semibold text-lg shadow-2xl shadow-violet-500/30 hover:shadow-violet-500/50 transition-all hover:-translate-y-1 overflow-hidden">
                    <span class="relative"><?php echo esc_html($t['final_cta']); ?></span>
                    <svg class="relative w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                </a>
            </div>

            <div class="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-white/40">
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
    ...
    <!-- ==================== TRANSPARENCY NOTE ==================== -->
    <section class="py-12 bg-zinc-900/30 border-t border-white/5">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-start gap-4 p-6 rounded-xl bg-white/[0.02] border border-white/10">
                ...
                <div>
                    <h4 class="font-semibold text-white mb-1"><?php echo esc_html($t['transparency_title']); ?></h4>
                    <p class="text-sm text-white/50 leading-relaxed"><?php echo esc_html($t['transparency_text']); ?></p>
                </div>
            </div>
        </div>
    </section>
