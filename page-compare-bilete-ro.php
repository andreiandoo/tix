<?php
/*
Template Name: Tixello vs Bilete.ro
*/
...
$competitor = tixello_get_comparison_by_slug('bilete-ro');
$carousel_items = tixello_get_carousel_comparisons('bilete-ro');

// Competitor-specific content
$competitor_content = [
    'ro' => [
        'verdict_text' => 'Bilete.ro este un marketplace de bilete operat in Romania de <strong class="text-red-400">PLG ROMANIA S.R.L.</strong> (parte a grupului Piletilevi). Pentru cumparatori, site-ul arata optiuni de plata variate, e-ticket print-at-home si livrare prin curier. Nu sunt publicate procentele de comision pentru organizatori si nici un SLA sau un model standard de payout catre organizatori.',
        'verdict_points' => [
            '<strong class="text-white/70">Cine opereaza:</strong> site-ul este proprietatea PLG ROMANIA S.R.L. (grupul Piletilevi a devenit actionar majoritar in 2023/2024).',
            '<strong class="text-white/70">Plati acceptate:</strong> card bancar (prin Romcard sau euPlatesc), transfer bancar, cash/ramburs, plus carduri/tichete culturale & cadou (Edenred, Pluxee, Up).',
            '<strong class="text-white/70">Livrare & acces:</strong> e-ticket (print-at-home) trimis pe e-mail; alternativ, curier (cu tarife publice).',
            '<strong class="text-red-400">Taxe catre client:</strong> "Cost procesare comanda" afisat separat — frecvent <strong class="text-red-400">2 lei + 2% per bilet</strong> (TVA inclus); site-ul precizeaza si posibilitatea unor taxe suplimentare.',
            '<strong class="text-white/70">Asigurare optionala:</strong> <strong class="text-red-400">En Garde</strong> (prin Eurolife) pentru protectia clientilor in caz de anulare/boala.',
            '<strong class="text-white/70">Observatie:</strong> nu exista public detalii privind comisionul pentru organizatori, SLA, sau payout-ul (direct vs. decont periodic).',
        ],
        ...
        'compare_1_competitor' => '<strong class="text-red-400">Nu publica procente</strong> pentru comisionul organizatorilor sau un model de payout catre organizatori; la client pot aparea taxe suplimentare afisate separat (de ex. <strong class="text-red-400">2 lei + 2%/bilet</strong>).',
        'compare_2_tixello' => '<strong class="text-emerald-400">Admin dedicat</strong> (nu-l imparti cu alti organizatori), GTM propriu, acces complet la date & analytics, export & integrari; instalare aproape plug & play pe serverul tau.',
        'compare_2_competitor' => 'Marketplace cu conturi client si pagini de ajutor; <strong class="text-red-400">nu comunica public</strong> un admin self-hosted per organizator, SLA sau detalii despre GTM per tenant.',
        ...
        'compare_3_competitor' => 'Accent pe distributie/incasare, e-ticket si curier, plus optional <strong class="text-red-400">asigurarea En Garde</strong> pentru clienti (prin Eurolife). eFactura/automatizari fiscale RO pentru organizatori nu sunt comunicate public.',
        'compare_4_tixello' => 'Harti de locuri cu blocari pe zone/randuri, tipuri multiple (early bird, pachete), emailing, coduri promo, segmente, rapoarte live pe conversie.',
        'compare_4_competitor' => 'E-ticket print-at-home (PDF pe e-mail) si curier, retea de puncte/casierii pentru anumite evenimente; metodele active depind de organizator si de eveniment.',
        'table' => [
            'cost_tixello' => '1-3% (platesti doar cand vinzi; inclus in pret sau peste)',
            'cost_competitor' => 'Taxe catre client afisate separat (ex. 2 lei + 2%/bilet); procente organizator nepublice',
            ...
            'admin_competitor' => 'Marketplace; pagini de ajutor; fara detalii publice despre admin dedicat/SLA',
            'delivery_tixello' => 'e-ticket, wallet, rapoarte live, email & promo',
            'delivery_competitor' => 'e-ticket (print-at-home) + curier; retea puncte/casierii selectiv',
            'fiscal_tixello' => 'Facturi + eFactura, documente post-eveniment',
            'fiscal_competitor' => 'Asigurare En Garde pentru client; eFactura necomunicata public',
            'refund_tixello' => 'Flexibila; integrata in dashboard',
            'refund_competitor' => 'Conform politica organizator; En Garde optional',
            'sla_tixello' => '99.99% · ~300ms',
            'sla_competitor' => 'Necomunicat public',
        ],
        'faq' => [
            [
                'q' => 'Publica Bilete.ro comisioanele pentru organizatori?',
                'a' => 'Nu am identificat procente publice; conditiile par contractuale. La Tixello, comisionul este transparent: 1-3%, fara abonamente sau costuri ascunse.',
            ],
            [
                'q' => 'Cum primesc biletele clientii pe Bilete.ro?',
                'a' => 'Prin e-ticket (PDF pe e-mail, print-at-home) sau curier; pentru unele comenzi exista ramburs.',
            ],
            [
                'q' => 'Ce taxe vede clientul pe Bilete.ro?',
                'a' => 'Site-ul mentioneaza "cost procesare comanda" (frecvent 2 lei + 2%/bilet) si posibilitatea altor taxe (intermediere, emitere bilet, curier), afisate separat in pasii de comanda. La Tixello, poti decide daca incluzi comisionul in pret sau il afisezi separat.',
            ],
            [
                'q' => 'Exista plata cu carduri culturale pe Bilete.ro?',
                'a' => 'Da — Edenred, Pluxee, Up (card/cadou/cultural), conform paginii de plata.',
            ],
            [
                'q' => 'Ce este asigurarea En Garde?',
                'a' => 'En Garde este o asigurare optionala oferita prin Eurolife pentru protectia clientilor in caz de anulare a evenimentului sau imposibilitate de participare din motive medicale. Este un cost suplimentar pe care il suporta cumparatorul.',
            ],
        ],
    ],
    'en' => [
        'verdict_text' => 'Bilete.ro is a ticket marketplace operated in Romania by <strong class="text-red-400">PLG ROMANIA S.R.L.</strong> (part of the Piletilevi group). For buyers, the site shows various payment options, e-ticket print-at-home and courier delivery. Commission percentages for organizers and no SLA or standard payout model to organizers are not published.',
        'verdict_points' => [
            '<strong class="text-white/70">Who operates:</strong> the site is owned by PLG ROMANIA S.R.L. (the Piletilevi group became majority shareholder in 2023/2024).',
            '<strong class="text-white/70">Accepted payments:</strong> bank card (via Romcard or euPlatesc), bank transfer, cash/COD, plus cultural/gift cards (Edenred, Pluxee, Up).',
            '<strong class="text-white/70">Delivery & access:</strong> e-ticket (print-at-home) sent by email; alternatively, courier (with public rates).',
            '<strong class="text-red-400">Client fees:</strong> "Order processing cost" displayed separately — typically <strong class="text-red-400">2 lei + 2% per ticket</strong> (VAT included); the site also mentions possible additional fees.',
            '<strong class="text-white/70">Optional insurance:</strong> <strong class="text-red-400">En Garde</strong> (via Eurolife) for customer protection in case of cancellation/illness.',
        ...
        'compare_1_competitor' => '<strong class="text-red-400">Does not publish percentages</strong> for organizer commission or a payout model to organizers; additional fees may appear to the customer displayed separately (e.g. <strong class="text-red-400">2 lei + 2%/ticket</strong>).',
        ...
        'compare_2_competitor' => 'Marketplace with client accounts and help pages; <strong class="text-red-400">does not publicly communicate</strong> a self-hosted admin per organizer, SLA or details about GTM per tenant.',
        ...
        'compare_3_competitor' => 'Focus on distribution/collection, e-ticket and courier, plus optional <strong class="text-red-400">En Garde insurance</strong> for customers (via Eurolife). e-invoicing/fiscal automations for RO organizers are not publicly communicated.',
        ...
        'compare_4_competitor' => 'E-ticket print-at-home (PDF by email) and courier, network of points/cashiers for certain events; active methods depend on organizer and event.',
        'table' => [
            'cost_tixello' => '1-3% (pay only when you sell; included or on top)',
            'cost_competitor' => 'Client fees displayed separately (e.g. 2 lei + 2%/ticket); organizer percentages not public',
            ...
            'admin_competitor' => 'Marketplace; help pages; no public details about dedicated admin/SLA',
            'delivery_tixello' => 'e-ticket, wallet, live reports, email & promo',
            'delivery_competitor' => 'e-ticket (print-at-home) + courier; network of points/cashiers selectively',
            'fiscal_tixello' => 'Invoices + e-invoicing, post-event documents',
            'fiscal_competitor' => 'En Garde insurance for client; e-invoicing not publicly communicated',
            'refund_tixello' => 'Flexible; integrated in dashboard',
            'refund_competitor' => 'Per organizer policy; En Garde optional',
            'sla_tixello' => '99.99% · ~300ms',
            'sla_competitor' => 'Not publicly communicated',
        ],
        'faq' => [
            [
                'q' => 'Does Bilete.ro publish organizer commissions?',
                'a' => 'We did not identify public percentages; conditions seem to be contractual. At Tixello, the commission is transparent: 1-3%, no subscriptions or hidden costs.',
            ],
            [
                'q' => 'How do customers receive tickets on Bilete.ro?',
                'a' => 'Via e-ticket (PDF by email, print-at-home) or courier; for some orders there is COD.',
            ],
            [
                'q' => 'What fees does the customer see on Bilete.ro?',
                'a' => 'The site mentions "order processing cost" (typically 2 lei + 2%/ticket) and the possibility of other fees (intermediation, ticket issuance, courier), displayed separately in the order steps. At Tixello, you can decide whether to include the commission in the price or display it separately.',
            ],
            [
                'q' => 'Is there payment with cultural cards on Bilete.ro?',
                'a' => 'Yes — Edenred, Pluxee, Up (card/gift/cultural), according to the payment page.',
            ],
            [
                'q' => 'What is En Garde insurance?',
                'a' => 'En Garde is optional insurance offered through Eurolife for customer protection in case of event cancellation or inability to participate for medical reasons. It is an additional cost borne by the buyer.',
            ],
        ],
    ],
];
...
<main class="antialiased bg-zinc-950 text-zinc-200">
    ...
    <section class="relative pt-24 pb-16 overflow-hidden sm:pt-32 sm:pb-24 bg-zinc-950">
        ...
        <div class="absolute w-24 h-24 rounded-full bottom-20 left-1/4 bg-red-500/10 blur-2xl animate-float"></div>
        ...
        <div class="relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col items-center justify-center gap-6 mb-12 lg:flex-row lg:gap-12 animate-fade-in-up">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl <?php echo esc_attr($competitor['icon_bg']); ?> border border-red-500/20 flex items-center justify-center">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-sm <?php echo esc_attr($competitor['icon_text']); ?>"><?php echo $lang === 'en' ? 'Marketplace (PLG)' : 'Marketplace (PLG)'; ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="relative group">
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-emerald-500/30 transition-all duration-300">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-3">
                                <svg class="flex-shrink-0 w-5 h-5 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/></svg>
                                <span class="text-sm text-white/70"><?php echo esc_html($competitor['name']); ?>: <?php echo $lang === 'en' ? '2 lei + 2%/ticket client' : '2 lei + 2%/bilet client'; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-cyan-500/5 border-emerald-500/20">
                    ...
                    <p class="mb-6 leading-relaxed text-white/70">
                        <?php echo $lang === 'en'
                            ...
                            : 'Tixello este o solutie B2B pentru organizatori: cashflow direct in contul tau, comision 1-3%, admin dedicat pe tenant, multi-processor plati, facturare automata + eFactura, tracking avansat si chat live cu echipa.'; ?>
                    </p>
            ...
            <div class="space-y-8">
                ...
                <div class="grid items-stretch gap-6 lg:grid-cols-2">
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-white/40"><?php echo $lang === 'en' ? 'Not specified publicly' : 'Nespecificat public'; ?></span>
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-white/40">2 lei + 2% client</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid items-stretch gap-6 lg:grid-cols-2">
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-white/40"><?php echo $lang === 'en' ? 'Help pages' : 'Pagini de ajutor'; ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid items-stretch gap-6 lg:grid-cols-2">
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-white/40">En Garde</span>
                ...
                <div class="grid items-stretch gap-6 lg:grid-cols-2">
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-white/40"><?php echo $lang === 'en' ? 'Network of points' : 'Retea puncte'; ?></span>
                        </div>
                    </div>
                </div>
    ...
    <section class="relative py-20 border-t sm:py-28 bg-zinc-950 border-white/5">
        <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <p class="mt-6 text-xs text-center text-white/30"><?php echo $lang === 'en'
                ? 'Key sources: Terms & conditions (owner, processing fees, mentions of additional fees), Payment (Romcard/euPlatesc, cultural/gift card, transfer, COD, cashiers/partners), e-ticket print-at-home, Courier delivery (rates), En Garde insurance, Piletilevi news.'
                : 'Citate cheie: Termeni & conditii (proprietar, taxe procesare, mentiuni despre taxe suplimentare), Plata (Romcard/euPlatesc, card cultural/cadou, transfer, ramburs, casierii/parteneri), e-ticket print-at-home, Livrare prin curier (tarife), Asigurarea En Garde, stiri Piletilevi.'; ?></p>
        </div>
    </section>
