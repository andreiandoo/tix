...
$competitor = tixello_get_comparison_by_slug('biletin');
$carousel_items = tixello_get_carousel_comparisons('biletin');

// Competitor-specific content
$competitor_content = [
    'ro' => [
        'verdict_text' => 'Biletin.ro este o platformă de ticketing/marketplace care oferă panou de administrare pentru organizatori, integrare de pixeli de marketing, acces la lista de clienți, iframe de vânzare pe site-ul tău, wallet (Apple/Google) și un modul <strong class="text-pink-400">Cashless (NFC)</strong>. Public, Biletin afișează un comision <strong class="text-pink-400">4-6%</strong> (configurabil să fie suportat de organizator sau de client); nu comunică un model standard de payout direct în contul organizatorului sau un SLA.',
        'verdict_points' => [
            '<strong class="text-white/70">Acces la clienți & marketing:</strong> acces la lista de cumpărători, retargetare automată a coșurilor abandonate, integrare de pixeli (view / add to cart / purchase).',
            '<strong class="text-white/70">Integrare pe site-ul tău:</strong> iframe cu întregul flux (selecție - plată - emitere bilet).',
            '<strong class="text-pink-400">Comision:</strong> afișat public 4% / 5% / 6%, configurabil ca suportat de client sau de organizator (simulator pe pagină).',
            '<strong class="text-white/70">Operațiuni & securitate:</strong> administrare cu 2FA, refund din panou la anulare, limitări anti-bot & anti-overload.',
            '<strong class="text-white/70">Wallet & aplicații:</strong> biletele se pot adăuga în Apple/Google Wallet; aplicații mobile disponibile (client + scanner).',
            '<strong class="text-pink-400">Cashless (NFC):</strong> portofel digital pe brățară/aplicație; Biletin gestionează fondurile și refund-urile Cashless conform T&C.',
        ],
        'compare_1_tixello' => 'Încasezi <strong class="text-emerald-400">direct în contul tău</strong>; plătești doar când vinzi; comision <strong class="text-emerald-400">1-3%</strong> (1% exclusiv / 2% non-exclusiv / 3% când Tixello procesează tranzacțiile). Poți include comisionul în preț sau îl poți afișa peste — optimizezi conversia cum vrei. Modelul de cost este simplu, transparent și ușor de simulat în bugetele tale.',
        'compare_1_competitor' => 'Comision public <strong class="text-pink-400">4-6%</strong>, configurabil ca suportat de client sau organizator. Site-ul nu publică un payout model standard către contul organizatorului (direct/imediat vs. decont periodic); trebuie clarificat contractual.',
        'compare_2_tixello' => '<strong class="text-emerald-400">Admin dedicat</strong> (nu-l împarți cu alți organizatori), GTM propriu pe tenant, acces complet la date & analytics, export & integrări — instalare aproape plug & play pe serverul tău. Practic, ai propria ta platformă, nu un „cont" într-un marketplace.',
        'compare_2_competitor' => 'Panou organizator cu acces la lista de clienți, integrare de pixeli și rapoarte. <strong class="text-pink-400">Nu comunică public</strong> un SLA sau un model de izolare tip admin dedicat self-hosted pe organizator, ca standard.',
        'compare_3_tixello' => 'Facturare automată, <strong class="text-emerald-400">eFactura</strong>, pachet documente fiscale & legale post-eveniment, multi-processor plăți (fallback & routing), tracking avansat al surselor, chat live. Îți scoți din cap mare parte din back-office.',
        'compare_3_competitor' => 'Accent pe marketing (pixeli) și Cashless. T&C precizează că procesarea cardului este la parteneri și că, în Cashless, refund-urile sunt procesate de Biletin și se percep <strong class="text-pink-400">comisioane administrative</strong> (ex. 3% + 1 leu sau taxă fixă pentru sume mici). Automatizările fiscale RO (eFactura) nu sunt comunicate public.',
        'compare_4_tixello' => '<strong class="text-emerald-400">Hărți de locuri</strong> cu blocări pe zone/rânduri, personalizare bilete, tipuri multiple (early bird, pachete), emailing și segmente direct în platformă, plus rapoarte live pe conversie.',
        'compare_4_competitor' => 'Hărți de locuri, scanare/validare, bilete în Apple/Google Wallet, aplicații mobile client + scanner. <strong class="text-pink-400">Cashless (NFC)</strong> disponibil. Foarte bun pentru operare & acces, mai puțin focus pe un stack de marketing self-hosted end-to-end.',
        'table' => [
            'cost_tixello' => '1-3% (plătești doar când vinzi; inclus în preț sau peste)',
            'cost_competitor' => '4-6% (explicit pe site); suportat de client sau organizator',
            'cashflow_tixello' => 'Banii direct în contul tău; multi-processor, fallback',
            'cashflow_competitor' => 'Nespecificat public (payout către organizator)',
            'admin_tixello' => 'Admin dedicat pe tenant; GTM propriu; export',
            'admin_competitor' => 'Panou organizator; acces la clienți, pixeli, rapoarte',
            'delivery_tixello' => 'Hartă + blocări, personalizare bilete, emailing',
            'delivery_competitor' => 'Hartă locuri, scanare, Wallet (Apple/Google), Cashless NFC',
            'fiscal_tixello' => 'Facturi + eFactura, documente post-eveniment automat',
            'fiscal_competitor' => 'Procesare card la parteneri; Cashless cu refund și comisioane admin în T&C; eFactura necomunicată',
            'refund_tixello' => 'Flexibilă; integrată în dashboard',
            'refund_competitor' => 'Refund din panou la anulare; Cashless: comisioane administrative',
            'sla_tixello' => '99.99% · ~300ms',
            'sla_competitor' => 'Necomunicat public',
        ],
        'faq' => [
            [
                'q' => 'Pot muta comisionul la client la Tixello?',
                'a' => 'Da. La Tixello poți include comisionul în preț sau îl poți afișa peste — exact ca să optimizezi conversia (la Biletin, sliderul arată explicit opțiunea client vs. organizator). Diferența este că la Tixello comisionul este 1-3%, nu 4-6%.',
            ],
            [
                'q' => 'Biletin are Cashless. Tixello are alternativă?',
                'a' => 'Biletin are Cashless (brățară/app, refund-uri cu comision administrativ). Tixello se concentrează pe cashflow direct, fiscalitate automată (eFactura) și multi-processor plăți. Pentru festivaluri cu Cashless dedicat, Tixello poate lucra cu integrări separate în funcție de setup-ul tău.',
            ],
            [
                'q' => 'Există procente publice pentru comisionul organizatorului la Biletin?',
                'a' => 'Da — 4-6% pe pagina „Pentru organizatori", cu opțiunea ca acest comision să fie suportat de client sau organizator. La Tixello, intervalul este 1-3%, fără alte feed-uri ascunse.',
            ],
            [
                'q' => 'Biletin oferă payout direct în contul meu?',
                'a' => 'Site-ul Biletin nu publică un model standard de payout către organizator (direct/imediat vs. decont periodic). La Tixello, pleci implicit de la bani direct în contul tău, cu multi-processor & fallback, astfel încât să îți poți planifica cashflow-ul fără surprize.',
            ],
            [
                'q' => 'Ce avantaje are Biletin pentru operarea la eveniment?',
                'a' => 'Biletin oferă aplicații mobile de scanare, integrare wallet (Apple/Google), și modulul Cashless (NFC) pentru plăți pe brățară. Tixello se concentrează pe back-office (facturare, eFactura, tracking) și cashflow direct, dar poți integra soluții de scanare și operare după preferințe.',
            ],
        ],
    ],
    'en' => [
        'verdict_text' => 'Biletin.ro is a ticketing/marketplace platform that offers an admin panel for organizers, marketing pixel integration, access to customer lists, sales iframe for your site, wallet (Apple/Google) and a <strong class="text-pink-400">Cashless (NFC)</strong> module. Publicly, Biletin displays a <strong class="text-pink-400">4-6%</strong> commission (configurable to be paid by organizer or customer); they do not communicate a standard direct payout model to the organizer account or an SLA.',
        'verdict_points' => [
            '<strong class="text-white/70">Customer access & marketing:</strong> access to buyer list, automatic abandoned cart retargeting, pixel integration (view / add to cart / purchase).',
            '<strong class="text-white/70">Integration on your site:</strong> iframe with the entire flow (selection - payment - ticket issuance).',
            '<strong class="text-pink-400">Commission:</strong> publicly displayed 4% / 5% / 6%, configurable as paid by customer or organizer (simulator on page).',
            '<strong class="text-white/70">Operations & security:</strong> admin with 2FA, refund from panel on cancellation, anti-bot & anti-overload limitations.',
            '<strong class="text-white/70">Wallet & apps:</strong> tickets can be added to Apple/Google Wallet; mobile apps available (client + scanner).',
            '<strong class="text-pink-400">Cashless (NFC):</strong> digital wallet on bracelet/app; Biletin manages funds and Cashless refunds according to T&C.',
        ],
        'compare_1_tixello' => 'You collect <strong class="text-emerald-400">directly in your account</strong>; you pay only when you sell; commission <strong class="text-emerald-400">1-3%</strong> (1% exclusive / 2% non-exclusive / 3% when Tixello processes transactions). You can include the commission in the price or display it on top — optimize conversion as you want. The cost model is simple, transparent and easy to simulate in your budgets.',
        'compare_1_competitor' => 'Public commission <strong class="text-pink-400">4-6%</strong>, configurable as paid by customer or organizer. The site does not publish a standard payout model to the organizer account (direct/immediate vs. periodic settlement); must be clarified contractually.',
        'compare_2_tixello' => '<strong class="text-emerald-400">Dedicated admin</strong> (not shared with other organizers), own GTM on tenant, full access to data & analytics, export & integrations — almost plug & play installation on your server. Basically, you have your own platform, not an "account" in a marketplace.',
        'compare_2_competitor' => 'Organizer panel with access to customer list, pixel integration and reports. <strong class="text-pink-400">Does not publicly communicate</strong> an SLA or a dedicated self-hosted admin isolation model per organizer, as standard.',
        'compare_3_tixello' => 'Automatic invoicing, <strong class="text-emerald-400">e-invoicing</strong>, fiscal & legal documents package post-event, multi-processor payments (fallback & routing), advanced source tracking, live chat. Takes a lot of back-office off your plate.',
        'compare_3_competitor' => 'Focus on marketing (pixels) and Cashless. T&C specifies that card processing is with partners and that, in Cashless, refunds are processed by Biletin and <strong class="text-pink-400">administrative fees</strong> are charged (e.g. 3% + 1 lei or fixed fee for small amounts). RO fiscal automations (e-invoicing) are not publicly communicated.',
        'compare_4_tixello' => '<strong class="text-emerald-400">Seat maps</strong> with zone/row blocking, ticket customization, multiple types (early bird, packages), emailing and segments directly in platform, plus live conversion reports.',
        'compare_4_competitor' => 'Seat maps, scanning/validation, tickets in Apple/Google Wallet, mobile client + scanner apps. <strong class="text-pink-400">Cashless (NFC)</strong> available. Very good for event operations & access, less focus on a self-hosted end-to-end marketing stack.',
        'table' => [
            'cost_tixello' => '1-3% (pay only when you sell; included in price or on top)',
            'cost_competitor' => '4-6% (explicit on site); paid by customer or organizer',
            'cashflow_tixello' => 'Money directly to your account; multi-processor, fallback',
            'cashflow_competitor' => 'Not publicly specified (payout to organizer)',
            'admin_tixello' => 'Dedicated admin per tenant; own GTM; export',
            'admin_competitor' => 'Organizer panel; access to customers, pixels, reports',
            'delivery_tixello' => 'Seat map + blocking, ticket customization, emailing',
            'delivery_competitor' => 'Seat map, scanning, Wallet (Apple/Google), Cashless NFC',
            'fiscal_tixello' => 'Invoices + e-invoicing, automatic post-event documents',
            'fiscal_competitor' => 'Card processing with partners; Cashless with refund and admin fees in T&C; e-invoicing not communicated',
            'refund_tixello' => 'Flexible; integrated in dashboard',
            'refund_competitor' => 'Refund from panel on cancellation; Cashless: administrative fees',
            'sla_tixello' => '99.99% · ~300ms',
            'sla_competitor' => 'Not publicly communicated',
        ],
        'faq' => [
            [
                'q' => 'Can I pass the commission to the customer at Tixello?',
                'a' => 'Yes. At Tixello you can include the commission in the price or display it on top — exactly to optimize conversion (at Biletin, the slider explicitly shows the customer vs. organizer option). The difference is that at Tixello the commission is 1-3%, not 4-6%.',
            ],
            [
                'q' => 'Biletin has Cashless. Does Tixello have an alternative?',
                'a' => 'Biletin has Cashless (bracelet/app, refunds with administrative fee). Tixello focuses on direct cashflow, automatic fiscalization (e-invoicing) and multi-processor payments. For festivals with dedicated Cashless, Tixello can work with separate integrations depending on your setup.',
            ],
            [
                'q' => 'Are there public percentages for the organizer commission at Biletin?',
                'a' => 'Yes — 4-6% on the "For organizers" page, with the option for this commission to be paid by customer or organizer. At Tixello, the range is 1-3%, with no other hidden fees.',
            ],
            [
                'q' => 'Does Biletin offer direct payout to my account?',
                'a' => 'The Biletin website does not publish a standard payout model to organizers (direct/immediate vs. periodic settlement). At Tixello, you start by default with money going directly to your account, with multi-processor & fallback, so you can plan your cashflow without surprises.',
            ],
            [
                'q' => 'What advantages does Biletin have for event operations?',
                'a' => 'Biletin offers mobile scanning apps, wallet integration (Apple/Google), and the Cashless (NFC) module for bracelet payments. Tixello focuses on back-office (invoicing, e-invoicing, tracking) and direct cashflow, but you can integrate scanning and operations solutions as you prefer.',
            ],
        ],
    ],
];
...
<main class="antialiased bg-zinc-950 text-zinc-200">
    ...
    <section class="relative pt-24 pb-16 overflow-hidden sm:pt-32 sm:pb-24 bg-zinc-950">
        ...
        <div class="absolute w-24 h-24 rounded-full bottom-20 left-1/4 bg-pink-500/10 blur-2xl animate-float"></div>
        ...
        <div class="relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col items-center justify-center gap-6 mb-12 lg:flex-row lg:gap-12 animate-fade-in-up">
                ...
                <div class="flex items-center gap-4">
                    <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl <?php echo esc_attr($competitor['icon_bg']); ?> border border-pink-500/20 flex items-center justify-center">
                ...
                <div class="relative group">
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-emerald-500/30 transition-all duration-300">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-3">
                                <svg class="flex-shrink-0 w-5 h-5 text-pink-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z"/></svg>
                                <span class="text-sm text-white/70"><?php echo esc_html($competitor['name']); ?>: 4-6%</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-violet-500/30 transition-all duration-300">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm text-white/70"><?php echo esc_html($competitor['name']); ?>: <?php echo $lang === 'en' ? 'Payout not publicly specified' : 'Payout nespecificat public'; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-cyan-500/30 transition-all duration-300">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm text-white/70"><?php echo esc_html($competitor['name']); ?>: <?php echo $lang === 'en' ? 'eFactura not communicated' : 'eFactura necomunicata'; ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3">
                            <div class="w-1.5 h-1.5 rounded-full bg-pink-400 mt-2 flex-shrink-0"></div>
            ...
            <div class="space-y-8">
                ...
                <div class="grid items-stretch gap-6 lg:grid-cols-2">
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 transition-all">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-white/40"><?php echo $lang === 'en' ? 'Organizer panel' : 'Panou organizator'; ?></span>
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-white/5 text-white/40"><?php echo $lang === 'en' ? 'Marketing pixels' : 'Pixeli marketing'; ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid items-stretch gap-6 lg:grid-cols-2">
                    <div class="relative p-6 transition-all border sm:p-8 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border-emerald-500/20 group hover:border-emerald-500/40">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-emerald-500/10 text-emerald-400"><?php echo $lang === 'en' ? 'Auto eFactura' : 'eFactura automat'; ?></span>
                ...
                <div class="grid items-stretch gap-6 lg:grid-cols-2">
                    <div class="relative p-6 transition-all border sm:p-8 rounded-2xl bg-gradient-to-br from-violet-500/10 to-violet-600/5 border-violet-500/20 hover:border-violet-500/40">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-violet-500/10 text-violet-400"><?php echo $lang === 'en' ? 'Segments' : 'Segmente'; ?></span>
                        </div>
                    </div>
                    ...
                    <div class="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-violet-500/10 to-violet-600/5 border border-violet-500/20 hover:border-violet-500/40 transition-all">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-violet-500/10 text-violet-400">Seat maps</span>
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-violet-500/10 text-violet-400">Apple/Google Wallet</span>
                            <span class="px-3 py-1 text-xs font-medium rounded-full bg-violet-500/10 text-violet-400">Cashless NFC</span>
                        </div>
                    </div>
                </div>
