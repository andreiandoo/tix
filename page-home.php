...
<section class="relative overflow-hidden hero-section" x-data="heroData()">
    ...
    <div class="relative z-10">
        ...
        <div class="px-4 pt-8 pb-16 mx-auto max-w-7xl sm:px-6 lg:px-8 sm:pt-12 lg:pt-16 sm:pb-20">
            ...
            <!-- Live Stats from API -->
            <div class="grid max-w-4xl grid-cols-2 gap-4 mx-auto mb-16 anim-fade-up delay-650 lg:grid-cols-4 sm:gap-6 sm:mb-20">
                <div class="p-5 text-center border sm:p-6 rounded-2xl bg-pink-500/5 border-pink-500/10">
                    <div class="flex items-center justify-center w-12 h-12 mx-auto mb-3 rounded-xl bg-pink-500/10">
                    ...
                    <span class="text-3xl font-black text-white sm:text-4xl"><?php echo esc_html( tixello_get_stat_value( 'events' ) ); ?></span>
                    <p class="mt-1 text-sm text-white/50">Evenimente</p>
                </div>
                <div class="p-5 text-center border sm:p-6 rounded-2xl bg-blue-500/5 border-blue-500/10">
                    <div class="flex items-center justify-center w-12 h-12 mx-auto mb-3 rounded-xl bg-blue-500/10">
                    ...
                    <span class="text-3xl font-black text-white sm:text-4xl"><?php echo esc_html( tixello_get_stat_value( 'customers' ) ); ?></span>
                    <p class="mt-1 text-sm text-white/50">Clienți</p>
                </div>
                <div class="p-5 text-center border sm:p-6 rounded-2xl bg-teal-500/5 border-teal-500/10">
                    <div class="flex items-center justify-center w-12 h-12 mx-auto mb-3 rounded-xl bg-teal-500/10">
                    ...
                    <span class="text-3xl font-black text-white sm:text-4xl"><?php echo esc_html( do_shortcode( '[tixello_revenue_eur]' ) ); ?></span>
                    <p class="mt-1 text-sm text-white/50">Venituri (EUR)</p>
                </div>
                <div class="p-5 text-center border sm:p-6 rounded-2xl bg-orange-500/5 border-orange-500/10">
                    <div class="flex items-center justify-center w-12 h-12 mx-auto mb-3 rounded-xl bg-orange-500/10">
                    ...
                    <span class="text-3xl font-black text-white sm:text-4xl"><?php echo esc_html( do_shortcode( '[tixello_revenue_ron]' ) ); ?></span>
                    <p class="mt-1 text-sm text-white/50">Venituri (RON)</p>
                </div>
            </div>
