...
<main class="bg-zinc-950 text-zinc-200 antialiased scroll-smooth" x-data="{ open: 1 }">

    <!-- ==================== HERO SECTION ==================== -->
    <section class="relative overflow-hidden pt-28 sm:pt-36 pb-20 sm:pb-28 bg-zinc-950">
        <!-- Background effects -->
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <!-- Main headline -->
                <h1 class="animate-fade-in-up text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-white leading-tight mb-6">
                ...
                <div class="animate-fade-in-up flex flex-col sm:flex-row items-center justify-center gap-4 [animation-delay:0.3s]">
                    ...
                    <a href="#pricing" class="w-full sm:w-auto px-8 py-5 rounded-2xl border border-white/20 text-white font-semibold hover:bg-white/5 transition-all">
                ...
                <div class="animate-fade-in mt-16 flex flex-col items-center gap-2 text-white/30 [animation-delay:0.4s]">
                    <span class="text-xs uppercase tracking-wider"><?php echo esc_html( $t['scroll_for_details'] ); ?></span>
    ...
    <!-- ==================== TRUST BADGES ==================== -->
    <section class="relative py-12 bg-zinc-900/50 border-t border-b border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-wrap items-center justify-center gap-8 sm:gap-16">
                <div class="text-center">
                    <p class="text-3xl sm:text-4xl font-black text-white mb-1 tabular-nums">0 <?php echo $current_lang === 'ro' ? 'lei' : ''; ?></p>
                ...
                <div class="hidden sm:block w-px h-12 bg-white/10"></div>
                <div class="text-center">
                    <p class="text-3xl sm:text-4xl font-black text-white mb-1 tabular-nums">99.99%</p>
    ...
    <section id="pricing" class="relative py-24 sm:py-32 bg-zinc-950">
        <div class="absolute inset-0 pointer-events-none">
            <div class="absolute top-0 left-1/3 w-96 h-96 bg-violet-600/5 rounded-full blur-3xl"></div>
            <div class="absolute bottom-0 right-1/3 w-96 h-96 bg-cyan-600/5 rounded-full blur-3xl"></div>
        </div>
            ...
            <div class="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="relative p-8 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 hover:border-emerald-500/30 hover:-translate-y-3 transition-all duration-400">
                    ...
                    <div class="text-center mb-8 pt-4">
                        <h3 class="text-xl font-bold text-white mb-2"><?php echo esc_html( $t['plan_exclusiv_name'] ); ?></h3>
                        <p class="text-white/50 text-sm mb-6"><?php echo esc_html( $t['plan_exclusiv_desc'] ); ?></p>
                        <div class="flex items-end justify-center gap-1">
                            <span class="text-6xl font-black text-emerald-400">1</span>
                            <span class="text-3xl font-bold text-emerald-400 mb-2">%</span>
                        </div>
                        <p class="text-white/40 text-sm mt-2"><?php echo esc_html( $t['per_transaction'] ); ?></p>
                    </div>
                    ...
                    <p class="text-xs text-white/30 text-center mb-6">
                        <?php echo esc_html( $t['plan_exclusiv_note'] ); ?>
                    </p>

                    <a href="/signup" class="block w-full py-4 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-semibold text-center hover:bg-emerald-500/20 transition-all">
                        <?php echo esc_html( $t['plan_exclusiv_cta'] ); ?>
                    </a>
                </div>

                <!-- 2% Flexibil (POPULAR) -->
                <div class="relative p-8 rounded-3xl bg-gradient-to-br from-violet-500/10 to-cyan-500/5 border-2 border-violet-500/30 lg:scale-105 lg:-my-4 hover:-translate-y-3 hover:border-violet-500/50 hover:shadow-[0_25px_50px_-12px_rgba(139,92,246,0.25)] transition-all duration-400">
                    <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <div class="text-center mb-8 pt-4">
                        <h3 class="text-xl font-bold text-white mb-2"><?php echo esc_html( $t['plan_flexibil_name'] ); ?></h3>
                        <p class="text-white/50 text-sm mb-6"><?php echo esc_html( $t['plan_flexibil_desc'] ); ?></p>
                        <div class="flex items-end justify-center gap-1">
                            <span class="text-6xl font-black text-violet-400">2</span>
                            <span class="text-3xl font-bold text-violet-400 mb-2">%</span>
                        </div>
                        <p class="text-white/40 text-sm mt-2"><?php echo esc_html( $t['per_transaction'] ); ?></p>
                    </div>
                ...
                <div class="relative p-8 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 hover:border-cyan-500/30 hover:-translate-y-3 transition-all duration-400">
                    ...
                    <div class="text-center mb-8 pt-4">
                        <h3 class="text-xl font-bold text-white mb-2"><?php echo esc_html( $t['plan_intermediat_name'] ); ?></h3>
                        <p class="text-white/50 text-sm mb-6"><?php echo esc_html( $t['plan_intermediat_desc'] ); ?></p>
                        <div class="flex items-end justify-center gap-1">
                            <span class="text-6xl font-black text-cyan-400">3</span>
                            <span class="text-3xl font-bold text-cyan-400 mb-2">%</span>
                        </div>
                        <p class="text-white/40 text-sm mt-2"><?php echo esc_html( $t['per_transaction'] ); ?></p>
                    </div>
                    ...
                    <a href="/signup" class="block w-full py-4 rounded-xl bg-cyan-500/10 border border-cyan-500/30 text-cyan-400 font-semibold text-center hover:bg-cyan-500/20 transition-all">
    ...
    <!-- ==================== MICROSERVICES ==================== -->
    <section id="services" class="relative py-24 sm:py-32 bg-zinc-900/30 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-16">
                <div class="text-center mb-10">
                    <h3 class="text-2xl font-bold text-white mb-2"><?php echo esc_html( $t['website_title'] ); ?></h3>
                ...
                <div class="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                    ...
                    <div class="p-6 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-white/10 text-center hover:-translate-y-1 transition-all duration-300">
                        ...
                        <h4 class="font-bold text-white mb-2"><?php echo esc_html( $t['website_subdomain'] ); ?></h4>
                        <p class="text-3xl font-black text-emerald-400 mb-2">0€</p>
                        <p class="text-sm text-white/50">eveniment.tics.ro</p>
                        <p class="text-xs text-white/30 mt-3"><?php echo esc_html( $t['website_subdomain_desc'] ); ?></p>
                    </div>
                    ...
                    <div class="p-6 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-violet-500/20 text-center hover:-translate-y-1 transition-all duration-300">
                        ...
                        <h4 class="font-bold text-white mb-2"><?php echo esc_html( $t['website_domain'] ); ?></h4>
                        <p class="text-3xl font-black text-violet-400 mb-2">15€<span class="text-lg text-white/40"><?php echo esc_html( $t['year'] ); ?></span></p>
                        <p class="text-sm text-white/50">evenimentul-tau.ro</p>
                        <p class="text-xs text-white/30 mt-3"><?php echo esc_html( $t['website_domain_desc'] ); ?></p>
                    </div>
                    ...
                    <div class="p-6 rounded-2xl bg-white/[0.03] backdrop-blur-xl border border-cyan-500/20 text-center hover:-translate-y-1 transition-all duration-300">
                        ...
                        <h4 class="font-bold text-white mb-2"><?php echo esc_html( $t['website_hosting'] ); ?></h4>
                        <p class="text-3xl font-black text-cyan-400 mb-2">2€<span class="text-lg text-white/40"><?php echo esc_html( $t['month'] ); ?></span></p>
                        <p class="text-sm text-white/50"><?php echo esc_html( $t['website_hosting_location'] ); ?></p>
                        <p class="text-xs text-white/30 mt-3"><?php echo esc_html( $t['website_hosting_desc'] ); ?></p>
                    </div>
    ...
    <!-- ==================== WHITE LABEL ==================== -->
    <section id="whitelabel" class="relative py-24 sm:py-32 bg-zinc-950 border-t border-white/5 overflow-hidden">
        <div class="absolute inset-0 pointer-events-none">
                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="text-center lg:text-right">
                            <div class="inline-block p-8 rounded-3xl bg-white/[0.05] backdrop-blur-[30px] border border-white/10">
                                <p class="text-sm text-white/40 uppercase tracking-wider mb-2"><?php echo esc_html( $t['wl_license'] ); ?></p>
                                <div class="flex items-end justify-center lg:justify-end gap-2 mb-4">
                                    <span class="text-6xl sm:text-7xl font-black text-white">20.000</span>
                                    <span class="text-3xl font-bold text-white/40 mb-3">€</span>
                                </div>
                                <p class="text-white/40 text-sm mb-6"><?php echo esc_html( $t['wl_payment'] ); ?></p>

                                <div class="pt-6 border-t border-white/10">
                                    <p class="text-xs text-white/30 mb-3"><?php echo esc_html( $t['wl_optional'] ); ?></p>
                                    <div class="flex flex-wrap justify-center lg:justify-end gap-2">
                                        <span class="px-3 py-1 rounded-full bg-white/5 text-white/50 text-xs"><?php echo esc_html( $t['wl_opt_ui'] ); ?></span>
                                        <span class="px-3 py-1 rounded-full bg-white/5 text-white/50 text-xs"><?php echo esc_html( $t['wl_opt_features'] ); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="relative py-24 bg-zinc-900/30 border-t border-white/5">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4"><?php echo esc_html( $t['calc_title'] ); ?></h2>
            ...
            <div class="p-8 rounded-3xl bg-white/[0.05] backdrop-blur-[30px] border border-white/10" x-data="{ tickets: 500, price: 100, plan: 2 }">
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-8">
                    <div>
                        <label class="block text-sm font-medium text-white/70 mb-3"><?php echo esc_html( $t['calc_tickets'] ); ?></label>
                        <input type="range" min="100" max="5000" step="100" x-model="tickets" class="w-full h-2 bg-white/10 rounded-lg appearance-none cursor-pointer accent-violet-500">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-white/70 mb-3"><?php echo esc_html( $t['calc_price'] ); ?></label>
                        <input type="range" min="20" max="500" step="10" x-model="price" class="w-full h-2 bg-white/10 rounded-lg appearance-none cursor-pointer accent-violet-500">
                        <div class="flex justify-between mt-2">
                ...
                <div class="mb-8">
                    <label class="block text-sm font-medium text-white/70 mb-3"><?php echo esc_html( $t['calc_plan'] ); ?></label>
                    <div class="flex gap-4">
                        <button @click="plan = 1" :class="plan === 1 ? 'bg-emerald-500/20 border-emerald-500/50 text-emerald-400' : 'bg-white/5 border-white/10 text-white/50'" class="flex-1 py-3 rounded-xl border font-semibold transition-all">1% <?php echo esc_html( $t['plan_exclusiv_name'] ); ?></button>
                        <button @click="plan = 2" :class="plan === 2 ? 'bg-violet-500/20 border-violet-500/50 text-violet-400' : 'bg-white/5 border-white/10 text-white/50'" class="flex-1 py-3 rounded-xl border font-semibold transition-all">2% <?php echo esc_html( $t['plan_flexibil_name'] ); ?></button>
                        <button @click="plan = 3" :class="plan === 3 ? 'bg-cyan-500/20 border-cyan-500/50 text-cyan-400' : 'bg-white/5 border-white/10 text-white/50'" class="flex-1 py-3 rounded-xl border font-semibold transition-all">3% <?php echo esc_html( $t['plan_intermediat_name'] ); ?></button>
                    </div>
                </div>

                <div class="grid sm:grid-cols-3 gap-6 p-6 rounded-2xl bg-white/[0.03] border border-white/10">
                    <div class="text-center">
                        <p class="text-sm text-white/40 mb-1"><?php echo esc_html( $t['calc_revenue'] ); ?></p>
                        <p class="text-2xl font-bold text-white" x-text="(tickets * price).toLocaleString() + ' <?php echo esc_js( $t['lei'] ); ?>'"></p>
                    </div>
                    <div class="text-center">
                        <p class="text-sm text-white/40 mb-1"><?php echo esc_html( $t['calc_commission'] ); ?></p>
                    ...
                    <div class="text-center">
                        <p class="text-sm text-white/40 mb-1"><?php echo esc_html( $t['calc_you_get'] ); ?></p>
    ...
    <!-- ==================== FAQ ==================== -->
    <section id="faq" class="relative py-24 sm:py-32 bg-zinc-950 border-t border-white/5">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl sm:text-4xl font-bold text-white mb-4"><?php echo esc_html( $t['faq_title'] ); ?></h2>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="rounded-2xl bg-white/[0.03] backdrop-blur-xl border overflow-hidden" :class="open === 1 ? 'border-violet-500/30' : 'border-white/10'">
                    <button @click="open = open === 1 ? null : 1" class="w-full flex items-center justify-between p-6 text-left">
                        <span class="font-semibold text-white pr-4"><?php echo esc_html( $t['faq_q1'] ); ?></span>
                        <svg class="w-5 h-5 text-violet-400 flex-shrink-0 transition-transform duration-300" :class="open === 1 ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                    <div x-show="open === 1" x-collapse x-cloak>
                        <div class="px-6 pb-6 text-white/60 leading-relaxed">
                ...
                <div class="rounded-2xl bg-white/[0.03] backdrop-blur-xl border overflow-hidden" :class="open === 2 ? 'border-violet-500/30' : 'border-white/10'">
                    <button @click="open = open === 2 ? null : 2" class="w-full flex items-center justify-between p-6 text-left">
                        <span class="font-semibold text-white pr-4"><?php echo esc_html( $t['faq_q2'] ); ?></span>
                        <svg class="w-5 h-5 text-violet-400 flex-shrink-0 transition-transform duration-300" :class="open === 2 ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                ...
                <div class="rounded-2xl bg-white/[0.03] backdrop-blur-xl border overflow-hidden" :class="open === 3 ? 'border-violet-500/30' : 'border-white/10'">
                    <button @click="open = open === 3 ? null : 3" class="w-full flex items-center justify-between p-6 text-left">
                        <span class="font-semibold text-white pr-4"><?php echo esc_html( $t['faq_q3'] ); ?></span>
                        <svg class="w-5 h-5 text-violet-400 flex-shrink-0 transition-transform duration-300" :class="open === 3 ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                ...
                <div class="rounded-2xl bg-white/[0.03] backdrop-blur-xl border overflow-hidden" :class="open === 4 ? 'border-violet-500/30' : 'border-white/10'">
                    <button @click="open = open === 4 ? null : 4" class="w-full flex items-center justify-between p-6 text-left">
                        <span class="font-semibold text-white pr-4"><?php echo esc_html( $t['faq_q4'] ); ?></span>
                        <svg class="w-5 h-5 text-violet-400 flex-shrink-0 transition-transform duration-300" :class="open === 4 ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                ...
                <div class="rounded-2xl bg-white/[0.03] backdrop-blur-xl border overflow-hidden" :class="open === 5 ? 'border-violet-500/30' : 'border-white/10'">
                    <button @click="open = open === 5 ? null : 5" class="w-full flex items-center justify-between p-6 text-left">
                        <span class="font-semibold text-white pr-4"><?php echo esc_html( $t['faq_q5'] ); ?></span>
                        <svg class="w-5 h-5 text-violet-400 flex-shrink-0 transition-transform duration-300" :class="open === 5 ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                ...
                <div class="rounded-2xl bg-white/[0.03] backdrop-blur-xl border overflow-hidden" :class="open === 6 ? 'border-violet-500/30' : 'border-white/10'">
                    <button @click="open = open === 6 ? null : 6" class="w-full flex items-center justify-between p-6 text-left">
                        <span class="font-semibold text-white pr-4"><?php echo esc_html( $t['faq_q6'] ); ?></span>
                        <svg class="w-5 h-5 text-violet-400 flex-shrink-0 transition-transform duration-300" :class="open === 6 ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
